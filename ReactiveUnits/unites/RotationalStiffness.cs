...
// </auto-generated>
// <copyright file="RotationalStiffness.cs" company="Webcorp">
...
#endif
	[DataContract]
	[TypeConverter(typeof(UnitTypeConverter<RotationalStiffness>))]
    public partial class RotationalStiffness : Unit<RotationalStiffness>
    {
        /// <summary>
        ...
        /// </summary>
        public RotationalStiffness():this(0.0)
        {
        ...
        {
            this.value = value;
			registeredSymbols = new List<string>() { "N*m/rad"};
        }
		...
		//[BsonSerializer(typeof(RotationalStiffnessSerializer))]
        ...
        /// <summary>
        /// Gets or sets the value of the rotational stiffness in the base unit.
        /// </summary>
        public override double Value
        {
			...
			set{
				throw new NotSupportedException("RotationalStiffness Doesn't support base value changing");
			}

        }

		 /// <summary>
        /// Gets if rotational stiffness is variable or not
        /// </summary>
        ...
        public static RotationalStiffness Parse(string input, IFormatProvider provider, IUnitProvider unitProvider)
        {
            ...
            {
				return new  RotationalStiffness(0);
        ...
        /// </returns>
        public override int CompareTo(RotationalStiffness other)
        {
        ...
        /// </returns>
        public override bool Equals(RotationalStiffness other)
        {
...
#if MONGO
	public class RotationalStiffnessSerializer:SerializerBase<RotationalStiffness>{
		public override RotationalStiffness Deserialize(BsonDeserializationContext context, BsonDeserializationArgs args)
        {
            var up = UnitProvider.Default;
            IUnit result;
            if(up.TryGetUnit(typeof(RotationalStiffness), context.Reader.ReadString(), out result))
                return (RotationalStiffness)result;
