...
// </auto-generated>
// <copyright file="Time.cs" company="Webcorp">
...
#endif
	[DataContract]
	[TypeConverter(typeof(UnitTypeConverter<Time>))]
    public partial class Time : Unit<Time>
    {
        /// <summary>
        ...
        {
            this.value = value;
			registeredSymbols = new List<string>() { "s","min","h","d","wk","ms"};
        }
		...
		//[BsonSerializer(typeof(TimeSerializer))]
        ...
        /// <summary>
        /// Gets or sets the value of the time in the base unit.
        /// </summary>
        public override double Value
        {
			...
			set{
				throw new NotSupportedException("Time Doesn't support base value changing");
			}

        }

		 /// <summary>
        /// Gets if time is variable or not
        /// </summary>
        ...
        /// A <see cref="Time"/> that represents the quantity in <paramref name="input" />. 
        /// </returns>
        public static Time Parse(string input, IUnitProvider unitProvider)
        {
            if (unitProvider == null)
            {
        ...
        public static bool TryParse(string input, IFormatProvider provider, IUnitProvider unitProvider, out Time result)
        {
            if (unitProvider == null)
            {
                unitProvider = provider as IUnitProvider ?? UnitProvider.Default;
        ...
        /// The <see cref="Time"/> .
        /// </returns>
        public static Time ParseJson(string input)
        {
        ...
        public override IUnit Add(IUnit x)
        {
            ...
            return new Time(this.value + x.Value);
        }
...
#if MONGO
	public class TimeSerializer:SerializerBase<Time>{
		public override Time Deserialize(BsonDeserializationContext context, BsonDeserializationArgs args)
        {
            ...
            IUnit result;
            if(up.TryGetUnit(typeof(Time), context.Reader.ReadString(), out result))
                return (Time)result;
