...
// </auto-generated>
// <copyright file="Curvature.cs" company="Webcorp">
...
#endif
	[DataContract]
	[TypeConverter(typeof(UnitTypeConverter<Curvature>))]
    public partial class Curvature : Unit<Curvature>
    {
        /// <summary>
        ...
        {
            this.value = value;
			registeredSymbols = new List<string>() { "1/m"};
        }
		...
		//[BsonSerializer(typeof(CurvatureSerializer))]
        ...
        /// <summary>
        /// Gets or sets the value of the curvature in the base unit.
        /// </summary>
        public override double Value
        {
		 ...
		 /// <summary>
        /// Gets if curvature is variable or not
        /// </summary>
        ...
        /// A <see cref="Curvature"/> that represents the quantity in <paramref name="input" />. 
        /// </returns>
        public static Curvature Parse(string input, IUnitProvider unitProvider)
        {
            if (unitProvider == null)
            {
        ...
        public static bool TryParse(string input, IFormatProvider provider, IUnitProvider unitProvider, out Curvature result)
        {
            if (unitProvider == null)
            {
                unitProvider = provider as IUnitProvider ?? UnitProvider.Default;
        ...
        /// </returns>
        public static Curvature ParseJson(string input)
        {
        ...
        /// The result of the operator. 
        /// </returns>
        public static Curvature operator +(Curvature x)
        {
            return new Curvature(x.value);
        }
        ...
        /// </returns>
        public override int CompareTo(Curvature other)
        {
        ...
        {
            return this.CompareTo((Curvature)obj);
        }
        ...
        {
            return this.ConvertTo((Curvature)unit);
        }
        ...
        /// </returns>
        public override bool Equals(Curvature other)
        {
        ...
        public override IUnit Add(IUnit x)
        {
            ...
            return new Curvature(this.value + x.Value);
        }
...
#if MONGO
	public class CurvatureSerializer:SerializerBase<Curvature>{
		public override Curvature Deserialize(BsonDeserializationContext context, BsonDeserializationArgs args)
        {
            var up = UnitProvider.Default;
            IUnit result;
            if(up.TryGetUnit(typeof(Curvature), context.Reader.ReadString(), out result))
