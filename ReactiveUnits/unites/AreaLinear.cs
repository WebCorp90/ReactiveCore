...
namespace Webcorp.unite
{
    ...
    public partial class AreaLinear : Unit<AreaLinear>
    {
        ...
        /// <summary>
        /// Gets or sets the value of the area linear in the base unit.
        /// </summary>
        public override double Value
        {
			...
			set{
				throw new NotSupportedException("AreaLinear Doesn't support base value changing");
			}

        }

		 /// <summary>
        /// Gets if area linear is variable or not
        /// </summary>
