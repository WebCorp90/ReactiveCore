...
// </auto-generated>
// <copyright file="ElectricConductivity.cs" company="Webcorp">
...
#endif
	[DataContract]
	[TypeConverter(typeof(UnitTypeConverter<ElectricConductivity>))]
    public partial class ElectricConductivity : Unit<ElectricConductivity>
    {
        /// <summary>
        ...
        /// </summary>
        public ElectricConductivity():this(0.0)
        {
        ...
        {
            this.value = value;
			registeredSymbols = new List<string>() { "S/m","S/cm","mS/cm","uS/cm"};
        }
		...
		//[BsonSerializer(typeof(ElectricConductivitySerializer))]
        ...
        /// <summary>
        /// Gets or sets the value of the electric conductivity in the base unit.
        /// </summary>
        public override double Value
        {
		 ...
		 /// <summary>
        /// Gets if electric conductivity is variable or not
        /// </summary>
        ...
        /// </returns>
        public override int CompareTo(ElectricConductivity other)
        {
        ...
        /// </returns>
        public override bool Equals(ElectricConductivity other)
        {
...
#if MONGO
	public class ElectricConductivitySerializer:SerializerBase<ElectricConductivity>{
		public override ElectricConductivity Deserialize(BsonDeserializationContext context, BsonDeserializationArgs args)
        {
            var up = UnitProvider.Default;
            IUnit result;
            if(up.TryGetUnit(typeof(ElectricConductivity), context.Reader.ReadString(), out result))
                return (ElectricConductivity)result;
