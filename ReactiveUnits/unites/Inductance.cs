...
// </auto-generated>
// <copyright file="Inductance.cs" company="Webcorp">
...
#endif
	[DataContract]
	[TypeConverter(typeof(UnitTypeConverter<Inductance>))]
    public partial class Inductance : Unit<Inductance>
    {
        /// <summary>
        ...
        {
            this.value = value;
			registeredSymbols = new List<string>() { "H","mH"};
        }
        ...
        /// The unit provider. 
        /// </param>
        public Inductance(string value, IUnitProvider unitProvider = null)
        {
		...
		//[BsonSerializer(typeof(InductanceSerializer))]
        ...
        /// <summary>
        /// Gets or sets the value of the inductance in the base unit.
        /// </summary>
        public override double Value
        {
		 ...
		 /// <summary>
        /// Gets if inductance is variable or not
        /// </summary>
        ...
        /// A <see cref="Inductance"/> that represents the quantity in <paramref name="input" />. 
        /// </returns>
        public static Inductance Parse(string input, IUnitProvider unitProvider)
        {
            if (unitProvider == null)
            {
        ...
        public static bool TryParse(string input, IFormatProvider provider, IUnitProvider unitProvider, out Inductance result)
        {
            if (unitProvider == null)
            {
                unitProvider = provider as IUnitProvider ?? UnitProvider.Default;
        ...
        /// <returns>
        /// The <see cref="Inductance"/> .
        /// </returns>
        public static Inductance ParseJson(string input)
        {
        ...
        {
            return new Inductance(x.value + y.value);
        }
        ...
        {
            return new Inductance(x.value / y);
        }
        ...
        /// The result of the operator. 
        /// </returns>
        public static double operator /(Inductance x, Inductance y)
        {
        ...
        {
            return new Inductance(x * y.value);
        }
        ...
        /// The result of the operator. 
        /// </returns>
        public static Inductance operator +(Inductance x)
        {
            return new Inductance(x.value);
        }
        ...
        /// <summary>
        /// Compares this instance to the specified <see cref="Inductance"/> and returns an indication of their relative values.
        /// </summary>
        /// <param name="other">
        /// The other <see cref="Inductance"/> . 
        /// </param>
        /// <returns>
        /// A signed number indicating the relative values of this instance and the other value. 
        /// </returns>
        public override int CompareTo(Inductance other)
        {
        ...
        {
            return this.CompareTo((Inductance)obj);
        }
        ...
        {
            return this.ConvertTo((Inductance)unit);
        }
        ...
        /// </returns>
        public double ConvertTo(Inductance unit)
        {
        ...
        {
            if (obj is Inductance)
            {
                return this.Equals((Inductance)obj);
            }
        ...
        /// <summary>
        /// Determines if the specified <see cref="Inductance"/> is equal to this instance.
        /// </summary>
        /// <param name="other">
        /// The other <see cref="Inductance"/> . 
        /// </param>
        ...
        /// </returns>
        public override bool Equals(Inductance other)
        {
        ...
        public override IUnit Add(IUnit x)
        {
            ...
            return new Inductance(this.value + x.Value);
        }
...
#if MONGO
	public class InductanceSerializer:SerializerBase<Inductance>{
		public override Inductance Deserialize(BsonDeserializationContext context, BsonDeserializationArgs args)
        {
            var up = UnitProvider.Default;
            IUnit result;
            if(up.TryGetUnit(typeof(Inductance), context.Reader.ReadString(), out result))
                return (Inductance)result;
