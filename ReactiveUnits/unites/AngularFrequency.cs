...
// </auto-generated>
// <copyright file="AngularFrequency.cs" company="Webcorp">
...
#endif
	[DataContract]
	[TypeConverter(typeof(UnitTypeConverter<AngularFrequency>))]
    public partial class AngularFrequency : Unit<AngularFrequency>
    {
        /// <summary>
        /// The backing field for the <see cref="RadiansPerSecond" /> property.
        /// </summary>
		[Unit("rad/s", true)]
		private static readonly AngularFrequency RadiansPerSecondField = new AngularFrequency(1);
		...
		/// <summary>
        /// Initializes a new instance of the <see cref="AngularFrequency"/> struct.
        /// </summary>
        public AngularFrequency():this(0.0)
        {
        ...
        /// The value. 
        /// </param>
        public AngularFrequency(double value)
        {
            this.value = value;
			registeredSymbols = new List<string>() { "rad/s"};
        }
        ...
        /// The unit provider. 
        /// </param>
        public AngularFrequency(string value, IUnitProvider unitProvider = null)
        {
        ...
        /// </summary>
		[Unit("rad/s", true)]
		        public static AngularFrequency RadiansPerSecond
        {
            get { return RadiansPerSecondField; }
        }
		...
		//[BsonSerializer(typeof(AngularFrequencySerializer))]
        ...
        /// <summary>
        /// Gets or sets the value of the angular frequency in the base unit.
        /// </summary>
        public override double Value
        {
			...
			set{
				throw new NotSupportedException("AngularFrequency Doesn't support base value changing");
			}

        }

		 /// <summary>
        /// Gets if angular frequency is variable or not
        /// </summary>
        ...
        public static bool TryParse(string input, IFormatProvider provider, IUnitProvider unitProvider, out AngularFrequency result)
        {
            if (unitProvider == null)
            {
                unitProvider = provider as IUnitProvider ?? UnitProvider.Default;
        ...
        /// <returns>
        /// The <see cref="AngularFrequency"/> .
        /// </returns>
        public static AngularFrequency ParseJson(string input)
        {
        ...
        /// </returns>
        public static AngularFrequency operator +(AngularFrequency x, AngularFrequency y)
        {
            return new AngularFrequency(x.value + y.value);
        }
        ...
        /// The result of the operator. 
        /// </returns>
        public static AngularFrequency operator /(AngularFrequency x, double y)
        {
            return new AngularFrequency(x.value / y);
        }
        ...
        /// The result of the operator. 
        /// </returns>
        public static double operator /(AngularFrequency x, AngularFrequency y)
        {
        ...
        /// The result of the operator. 
        /// </returns>
        public static bool operator ==(AngularFrequency x, AngularFrequency y)
        {
        ...
        /// The result of the operator. 
        /// </returns>
        public static AngularFrequency operator *(double x, AngularFrequency y)
        {
            return new AngularFrequency(x * y.value);
        }
        ...
        /// The result of the operator. 
        /// </returns>
        public static AngularFrequency operator +(AngularFrequency x)
        {
            return new AngularFrequency(x.value);
        }
        ...
        /// <summary>
        /// Compares this instance to the specified <see cref="AngularFrequency"/> and returns an indication of their relative values.
        /// </summary>
        /// <param name="other">
        /// The other <see cref="AngularFrequency"/> . 
        /// </param>
        /// <returns>
        /// A signed number indicating the relative values of this instance and the other value. 
        /// </returns>
        public override int CompareTo(AngularFrequency other)
        {
        ...
        {
            return this.CompareTo((AngularFrequency)obj);
        }
        ...
        {
            return this.ConvertTo((AngularFrequency)unit);
        }
        ...
        /// </returns>
        public double ConvertTo(AngularFrequency unit)
        {
        ...
        {
            if (obj is AngularFrequency)
            {
                return this.Equals((AngularFrequency)obj);
            }
        ...
        /// <summary>
        /// Determines if the specified <see cref="AngularFrequency"/> is equal to this instance.
        /// </summary>
        /// <param name="other">
        /// The other <see cref="AngularFrequency"/> . 
        /// </param>
        ...
        /// </returns>
        public override bool Equals(AngularFrequency other)
        {
...
#if MONGO
	public class AngularFrequencySerializer:SerializerBase<AngularFrequency>{
		public override AngularFrequency Deserialize(BsonDeserializationContext context, BsonDeserializationArgs args)
        {
            var up = UnitProvider.Default;
            IUnit result;
            if(up.TryGetUnit(typeof(AngularFrequency), context.Reader.ReadString(), out result))
                return (AngularFrequency)result;
