...
// </auto-generated>
// <copyright file="TemperatureDifference.cs" company="Webcorp">
...
#endif
	[DataContract]
	[TypeConverter(typeof(UnitTypeConverter<TemperatureDifference>))]
    public partial class TemperatureDifference : Unit<TemperatureDifference>
    {
        /// <summary>
        ...
        /// </summary>
        public TemperatureDifference():this(0.0)
        {
        ...
        {
            this.value = value;
			registeredSymbols = new List<string>() { "K","C","F"};
        }
		...
		//[BsonSerializer(typeof(TemperatureDifferenceSerializer))]
        ...
        /// <summary>
        /// Gets or sets the value of the temperature difference in the base unit.
        /// </summary>
        public override double Value
        {
		 ...
		 /// <summary>
        /// Gets if temperature difference is variable or not
        /// </summary>
        ...
        public static TemperatureDifference Parse(string input, IFormatProvider provider, IUnitProvider unitProvider)
        {
            ...
            {
				return new  TemperatureDifference(0);
        ...
        /// A <see cref="TemperatureDifference"/> that represents the quantity in <paramref name="input" />. 
        /// </returns>
        public static TemperatureDifference Parse(string input, IUnitProvider unitProvider)
        {
            if (unitProvider == null)
            {
        ...
        public static bool TryParse(string input, IFormatProvider provider, IUnitProvider unitProvider, out TemperatureDifference result)
        {
            if (unitProvider == null)
            {
                unitProvider = provider as IUnitProvider ?? UnitProvider.Default;
        ...
        /// </returns>
        public static TemperatureDifference ParseJson(string input)
        {
        ...
        /// The result of the operator. 
        /// </returns>
        public static TemperatureDifference operator +(TemperatureDifference x)
        {
            return new TemperatureDifference(x.value);
        }
        ...
        /// </returns>
        public override int CompareTo(TemperatureDifference other)
        {
        ...
        /// </returns>
        public override bool Equals(TemperatureDifference other)
        {
        ...
        {
            if (!(x is TemperatureDifference))
            {
                throw new InvalidOperationException("Can only add quantities of the same types.");
            }

            return new TemperatureDifference(this.value + x.Value);
        }
...
#if MONGO
	public class TemperatureDifferenceSerializer:SerializerBase<TemperatureDifference>{
		public override TemperatureDifference Deserialize(BsonDeserializationContext context, BsonDeserializationArgs args)
        {
            var up = UnitProvider.Default;
            IUnit result;
            if(up.TryGetUnit(typeof(TemperatureDifference), context.Reader.ReadString(), out result))
                return (TemperatureDifference)result;

            return base.Deserialize(context, args);
        } 
	}
#endif
	public enum TemperatureDifferenceUnit{
		Kelvin,
		DegreeCelsius,
		DegreeFahrenheit
	}
