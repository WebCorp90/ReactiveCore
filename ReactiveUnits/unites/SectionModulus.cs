...
// </auto-generated>
// <copyright file="SectionModulus.cs" company="Webcorp">
...
#endif
	[DataContract]
	[TypeConverter(typeof(UnitTypeConverter<SectionModulus>))]
    public partial class SectionModulus : Unit<SectionModulus>
    {
        /// <summary>
        ...
        /// </summary>
        public SectionModulus():this(0.0)
        {
		...
		//[BsonSerializer(typeof(SectionModulusSerializer))]
        ...
        /// <summary>
        /// Gets or sets the value of the section modulus in the base unit.
        /// </summary>
        public override double Value
        {
			...
			set{
				throw new NotSupportedException("SectionModulus Doesn't support base value changing");
			}

        }

		 /// <summary>
        /// Gets if section modulus is variable or not
        /// </summary>
        ...
        /// </returns>
        public override int CompareTo(SectionModulus other)
        {
        ...
        /// </returns>
        public override bool Equals(SectionModulus other)
        {
...
#if MONGO
	public class SectionModulusSerializer:SerializerBase<SectionModulus>{
		public override SectionModulus Deserialize(BsonDeserializationContext context, BsonDeserializationArgs args)
        {
            var up = UnitProvider.Default;
            IUnit result;
            if(up.TryGetUnit(typeof(SectionModulus), context.Reader.ReadString(), out result))
                return (SectionModulus)result;
