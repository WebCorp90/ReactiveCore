...
// </auto-generated>
// <copyright file="Radiation.cs" company="Webcorp">
...
#endif
	[DataContract]
	[TypeConverter(typeof(UnitTypeConverter<Radiation>))]
    public partial class Radiation : Unit<Radiation>
    {
        /// <summary>
        /// The backing field for the <see cref="Becquerel" /> property.
        /// </summary>
		[Unit("Bq", true)]
		private static readonly Radiation BecquerelField = new Radiation(1);
		...
		/// <summary>
        /// Initializes a new instance of the <see cref="Radiation"/> struct.
        /// </summary>
        public Radiation():this(0.0)
        {
        ...
        {
            this.value = value;
			registeredSymbols = new List<string>() { "Bq"};
        }
        ...
        /// The unit provider. 
        /// </param>
        public Radiation(string value, IUnitProvider unitProvider = null)
        {
        ...
        /// </summary>
		[Unit("Bq", true)]
		        public static Radiation Becquerel
        {
            get { return BecquerelField; }
        }
		...
		//[BsonSerializer(typeof(RadiationSerializer))]
        ...
        /// <summary>
        /// Gets or sets the value of the radiation in the base unit.
        /// </summary>
        public override double Value
        {
			...
			set{
				throw new NotSupportedException("Radiation Doesn't support base value changing");
			}

        }

		 /// <summary>
        /// Gets if radiation is variable or not
        /// </summary>
        ...
        /// A <see cref="Radiation"/> that represents the quantity in <paramref name="input" />. 
        /// </returns>
        public static Radiation Parse(string input, IUnitProvider unitProvider)
        {
            if (unitProvider == null)
            {
        ...
        public static bool TryParse(string input, IFormatProvider provider, IUnitProvider unitProvider, out Radiation result)
        {
            if (unitProvider == null)
            {
                unitProvider = provider as IUnitProvider ?? UnitProvider.Default;
        ...
        /// <returns>
        /// The <see cref="Radiation"/> .
        /// </returns>
        public static Radiation ParseJson(string input)
        {
        ...
        /// </returns>
        public static Radiation operator +(Radiation x, Radiation y)
        {
            return new Radiation(x.value + y.value);
        }
        ...
        /// The result of the operator. 
        /// </returns>
        public static Radiation operator /(Radiation x, double y)
        {
            return new Radiation(x.value / y);
        }
        ...
        /// The result of the operator. 
        /// </returns>
        public static double operator /(Radiation x, Radiation y)
        {
        ...
        /// The result of the operator. 
        /// </returns>
        public static bool operator ==(Radiation x, Radiation y)
        {
        ...
        /// The result of the operator. 
        /// </returns>
        public static Radiation operator *(double x, Radiation y)
        {
            return new Radiation(x * y.value);
        }
        ...
        /// The result of the operator. 
        /// </returns>
        public static Radiation operator +(Radiation x)
        {
            return new Radiation(x.value);
        }
        ...
        /// <summary>
        /// Compares this instance to the specified <see cref="Radiation"/> and returns an indication of their relative values.
        /// </summary>
        /// <param name="other">
        /// The other <see cref="Radiation"/> . 
        /// </param>
        /// <returns>
        /// A signed number indicating the relative values of this instance and the other value. 
        /// </returns>
        public override int CompareTo(Radiation other)
        {
        ...
        {
            return this.CompareTo((Radiation)obj);
        }
        ...
        {
            return this.ConvertTo((Radiation)unit);
        }
        ...
        /// </returns>
        public double ConvertTo(Radiation unit)
        {
        ...
        public override bool Equals(object obj)
        {
            if (obj is Radiation)
            {
                return this.Equals((Radiation)obj);
            }
        ...
        /// <summary>
        /// Determines if the specified <see cref="Radiation"/> is equal to this instance.
        /// </summary>
        /// <param name="other">
        /// The other <see cref="Radiation"/> . 
        /// </param>
        ...
        /// </returns>
        public override bool Equals(Radiation other)
        {
        ...
        public override IUnit Add(IUnit x)
        {
            ...
            return new Radiation(this.value + x.Value);
        }
...
#if MONGO
	public class RadiationSerializer:SerializerBase<Radiation>{
		public override Radiation Deserialize(BsonDeserializationContext context, BsonDeserializationArgs args)
        {
            var up = UnitProvider.Default;
            IUnit result;
            if(up.TryGetUnit(typeof(Radiation), context.Reader.ReadString(), out result))
