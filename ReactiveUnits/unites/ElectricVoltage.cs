...
// </auto-generated>
// <copyright file="ElectricVoltage.cs" company="Webcorp">
...
#endif
	[DataContract]
	[TypeConverter(typeof(UnitTypeConverter<ElectricVoltage>))]
    public partial class ElectricVoltage : Unit<ElectricVoltage>
    {
        /// <summary>
        ...
        /// </summary>
        public ElectricVoltage():this(0.0)
        {
        ...
        {
            this.value = value;
			registeredSymbols = new List<string>() { "V","mV","µV"};
        }
		...
		//[BsonSerializer(typeof(ElectricVoltageSerializer))]
        ...
        /// <summary>
        /// Gets or sets the value of the electric voltage in the base unit.
        /// </summary>
        public override double Value
        {
			...
			set{
				throw new NotSupportedException("ElectricVoltage Doesn't support base value changing");
			}

        }

		 /// <summary>
        /// Gets if electric voltage is variable or not
        /// </summary>
        ...
        /// </returns>
        public override int CompareTo(ElectricVoltage other)
        {
        ...
        /// </returns>
        public override bool Equals(ElectricVoltage other)
        {
...
#if MONGO
	public class ElectricVoltageSerializer:SerializerBase<ElectricVoltage>{
		public override ElectricVoltage Deserialize(BsonDeserializationContext context, BsonDeserializationArgs args)
        {
            var up = UnitProvider.Default;
            IUnit result;
            if(up.TryGetUnit(typeof(ElectricVoltage), context.Reader.ReadString(), out result))
                return (ElectricVoltage)result;

            return base.Deserialize(context, args);
        } 
	}
#endif
	public enum ElectricVoltageUnit{
		Volt,
Millivolt,
Microvolt
	}
