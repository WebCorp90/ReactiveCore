...
// </auto-generated>
// <copyright file="TypographicResolution.cs" company="Webcorp">
...
#endif
	[DataContract]
	[TypeConverter(typeof(UnitTypeConverter<TypographicResolution>))]
    public partial class TypographicResolution : Unit<TypographicResolution>
    {
        /// <summary>
        ...
        /// </summary>
        public TypographicResolution():this(0.0)
        {
        ...
        {
            this.value = value;
			registeredSymbols = new List<string>() { "dpi"};
        }
		...
		//[BsonSerializer(typeof(TypographicResolutionSerializer))]
        ...
        /// <summary>
        /// Gets or sets the value of the typographic resolution in the base unit.
        /// </summary>
        public override double Value
        {
			...
			set{
				throw new NotSupportedException("TypographicResolution Doesn't support base value changing");
			}

        }

		 /// <summary>
        /// Gets if typographic resolution is variable or not
        /// </summary>
        ...
        public static TypographicResolution Parse(string input, IFormatProvider provider, IUnitProvider unitProvider)
        {
            ...
            {
				return new  TypographicResolution(0);
        ...
        public static bool TryParse(string input, IFormatProvider provider, IUnitProvider unitProvider, out TypographicResolution result)
        {
            if (unitProvider == null)
            {
                unitProvider = provider as IUnitProvider ?? UnitProvider.Default;
        ...
        /// </returns>
        public static TypographicResolution ParseJson(string input)
        {
        ...
        /// The result of the operator. 
        /// </returns>
        public static TypographicResolution operator +(TypographicResolution x)
        {
            return new TypographicResolution(x.value);
        }
        ...
        /// </returns>
        public override int CompareTo(TypographicResolution other)
        {
        ...
        /// </returns>
        public override bool Equals(TypographicResolution other)
        {
        ...
        {
            if (!(x is TypographicResolution))
            {
                throw new InvalidOperationException("Can only add quantities of the same types.");
            }

            return new TypographicResolution(this.value + x.Value);
        }
...
#if MONGO
	public class TypographicResolutionSerializer:SerializerBase<TypographicResolution>{
		public override TypographicResolution Deserialize(BsonDeserializationContext context, BsonDeserializationArgs args)
        {
            var up = UnitProvider.Default;
            IUnit result;
            if(up.TryGetUnit(typeof(TypographicResolution), context.Reader.ReadString(), out result))
                return (TypographicResolution)result;

            return base.Deserialize(context, args);
        } 
	}
#endif
	public enum TypographicResolutionUnit{
		DotsPerInch
	}
