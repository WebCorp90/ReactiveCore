...
// </auto-generated>
// <copyright file="FirstMomentOfArea.cs" company="Webcorp">
...
#endif
	[DataContract]
	[TypeConverter(typeof(UnitTypeConverter<FirstMomentOfArea>))]
    public partial class FirstMomentOfArea : Unit<FirstMomentOfArea>
    {
        /// <summary>
        /// The backing field for the <see cref="MetreCubed" /> property.
        /// </summary>
		[Unit("m^3", true)]
		private static readonly FirstMomentOfArea MetreCubedField = new FirstMomentOfArea(1);
		...
		/// <summary>
        /// Initializes a new instance of the <see cref="FirstMomentOfArea"/> struct.
        /// </summary>
        public FirstMomentOfArea():this(0.0)
        {
        ...
        /// The value. 
        /// </param>
        public FirstMomentOfArea(double value)
        {
            this.value = value;
			registeredSymbols = new List<string>() { "m^3"};
        }
        ...
        /// The unit provider. 
        /// </param>
        public FirstMomentOfArea(string value, IUnitProvider unitProvider = null)
        {
        ...
        /// </summary>
		[Unit("m^3", true)]
		        public static FirstMomentOfArea MetreCubed
        {
		...
		//[BsonSerializer(typeof(FirstMomentOfAreaSerializer))]
        ...
        /// <summary>
        /// Gets or sets the value of the first moment of area in the base unit.
        /// </summary>
        public override double Value
        {
			...
			set{
				throw new NotSupportedException("FirstMomentOfArea Doesn't support base value changing");
			}

        }

		 /// <summary>
        /// Gets if first moment of area is variable or not
        /// </summary>
        ...
        public static FirstMomentOfArea Parse(string input, IFormatProvider provider, IUnitProvider unitProvider)
        {
            ...
            {
				return new  FirstMomentOfArea(0);
        ...
        public static bool TryParse(string input, IFormatProvider provider, IUnitProvider unitProvider, out FirstMomentOfArea result)
        {
            if (unitProvider == null)
            {
                unitProvider = provider as IUnitProvider ?? UnitProvider.Default;
        ...
        /// <returns>
        /// The <see cref="FirstMomentOfArea"/> .
        /// </returns>
        public static FirstMomentOfArea ParseJson(string input)
        {
        ...
        /// </returns>
        public static FirstMomentOfArea operator +(FirstMomentOfArea x, FirstMomentOfArea y)
        {
            return new FirstMomentOfArea(x.value + y.value);
        }
        ...
        /// The result of the operator. 
        /// </returns>
        public static FirstMomentOfArea operator /(FirstMomentOfArea x, double y)
        {
            return new FirstMomentOfArea(x.value / y);
        }
        ...
        /// The result of the operator. 
        /// </returns>
        public static double operator /(FirstMomentOfArea x, FirstMomentOfArea y)
        {
        ...
        /// The result of the operator. 
        /// </returns>
        public static bool operator ==(FirstMomentOfArea x, FirstMomentOfArea y)
        {
        ...
        /// The result of the operator. 
        /// </returns>
        public static FirstMomentOfArea operator *(double x, FirstMomentOfArea y)
        {
            return new FirstMomentOfArea(x * y.value);
        }
        ...
        /// The result of the operator. 
        /// </returns>
        public static FirstMomentOfArea operator +(FirstMomentOfArea x)
        {
            return new FirstMomentOfArea(x.value);
        }
        ...
        /// <summary>
        /// Compares this instance to the specified <see cref="FirstMomentOfArea"/> and returns an indication of their relative values.
        /// </summary>
        /// <param name="other">
        /// The other <see cref="FirstMomentOfArea"/> . 
        /// </param>
        /// <returns>
        /// A signed number indicating the relative values of this instance and the other value. 
        /// </returns>
        public override int CompareTo(FirstMomentOfArea other)
        {
        ...
        {
            return this.ConvertTo((FirstMomentOfArea)unit);
        }
        ...
        /// </returns>
        public double ConvertTo(FirstMomentOfArea unit)
        {
        ...
        /// <summary>
        /// Determines if the specified <see cref="FirstMomentOfArea"/> is equal to this instance.
        /// </summary>
        /// <param name="other">
        /// The other <see cref="FirstMomentOfArea"/> . 
        /// </param>
        ...
        /// </returns>
        public override bool Equals(FirstMomentOfArea other)
        {
...
#if MONGO
	public class FirstMomentOfAreaSerializer:SerializerBase<FirstMomentOfArea>{
		public override FirstMomentOfArea Deserialize(BsonDeserializationContext context, BsonDeserializationArgs args)
        {
            var up = UnitProvider.Default;
            IUnit result;
            if(up.TryGetUnit(typeof(FirstMomentOfArea), context.Reader.ReadString(), out result))
                return (FirstMomentOfArea)result;

            return base.Deserialize(context, args);
        } 
	}
#endif
	public enum FirstMomentOfAreaUnit{
		MetreCubed
	}
