...
// </auto-generated>
// <copyright file="ElectricDipole.cs" company="Webcorp">
...
#endif
	[DataContract]
	[TypeConverter(typeof(UnitTypeConverter<ElectricDipole>))]
    public partial class ElectricDipole : Unit<ElectricDipole>
    {
        /// <summary>
        ...
        /// </summary>
        public ElectricDipole():this(0.0)
        {
        ...
        /// The value. 
        /// </param>
        public ElectricDipole(double value)
        {
            this.value = value;
			registeredSymbols = new List<string>() { "C*m","D"};
        }
        ...
        /// The unit provider. 
        /// </param>
        public ElectricDipole(string value, IUnitProvider unitProvider = null)
        {
		...
		//[BsonSerializer(typeof(ElectricDipoleSerializer))]
        ...
        /// <summary>
        /// Gets or sets the value of the electric dipole in the base unit.
        /// </summary>
        public override double Value
        {
			...
			set{
				throw new NotSupportedException("ElectricDipole Doesn't support base value changing");
			}

        }

		 /// <summary>
        /// Gets if electric dipole is variable or not
        /// </summary>
        ...
        public static bool TryParse(string input, IFormatProvider provider, IUnitProvider unitProvider, out ElectricDipole result)
        {
            if (unitProvider == null)
            {
                unitProvider = provider as IUnitProvider ?? UnitProvider.Default;
        ...
        /// <returns>
        /// The <see cref="ElectricDipole"/> .
        /// </returns>
        public static ElectricDipole ParseJson(string input)
        {
        ...
        /// </returns>
        public static ElectricDipole operator +(ElectricDipole x, ElectricDipole y)
        {
            return new ElectricDipole(x.value + y.value);
        }
        ...
        /// The result of the operator. 
        /// </returns>
        public static ElectricDipole operator /(ElectricDipole x, double y)
        {
            return new ElectricDipole(x.value / y);
        }
        ...
        /// The result of the operator. 
        /// </returns>
        public static double operator /(ElectricDipole x, ElectricDipole y)
        {
        ...
        /// The result of the operator. 
        /// </returns>
        public static bool operator ==(ElectricDipole x, ElectricDipole y)
        {
        ...
        /// The result of the operator. 
        /// </returns>
        public static ElectricDipole operator *(double x, ElectricDipole y)
        {
            return new ElectricDipole(x * y.value);
        }
        ...
        /// The result of the operator. 
        /// </returns>
        public static ElectricDipole operator +(ElectricDipole x)
        {
            return new ElectricDipole(x.value);
        }
        ...
        /// <summary>
        /// Compares this instance to the specified <see cref="ElectricDipole"/> and returns an indication of their relative values.
        /// </summary>
        /// <param name="other">
        /// The other <see cref="ElectricDipole"/> . 
        /// </param>
        /// <returns>
        /// A signed number indicating the relative values of this instance and the other value. 
        /// </returns>
        public override int CompareTo(ElectricDipole other)
        {
        ...
        {
            return this.CompareTo((ElectricDipole)obj);
        }
        ...
        {
            return this.ConvertTo((ElectricDipole)unit);
        }
        ...
        /// </returns>
        public double ConvertTo(ElectricDipole unit)
        {
        ...
        /// <summary>
        /// Determines if the specified <see cref="ElectricDipole"/> is equal to this instance.
        /// </summary>
        /// <param name="other">
        /// The other <see cref="ElectricDipole"/> . 
        /// </param>
        ...
        /// </returns>
        public override bool Equals(ElectricDipole other)
        {
...
#if MONGO
	public class ElectricDipoleSerializer:SerializerBase<ElectricDipole>{
		public override ElectricDipole Deserialize(BsonDeserializationContext context, BsonDeserializationArgs args)
        {
            var up = UnitProvider.Default;
            IUnit result;
            if(up.TryGetUnit(typeof(ElectricDipole), context.Reader.ReadString(), out result))
                return (ElectricDipole)result;

            return base.Deserialize(context, args);
        } 
	}
#endif
	public enum ElectricDipoleUnit{
		CoulombMetre,
Debye
	}
