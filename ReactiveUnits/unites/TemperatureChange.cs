...
// </auto-generated>
// <copyright file="TemperatureChange.cs" company="Webcorp">
...
#endif
	[DataContract]
	[TypeConverter(typeof(UnitTypeConverter<TemperatureChange>))]
    public partial class TemperatureChange : Unit<TemperatureChange>
    {
        /// <summary>
        ...
        /// </summary>
        public TemperatureChange():this(0.0)
        {
        ...
        {
            this.value = value;
			registeredSymbols = new List<string>() { "K/s","C/s","F/s","K/hr","C/hr","F/hr"};
        }
		...
		//[BsonSerializer(typeof(TemperatureChangeSerializer))]
        ...
        /// <summary>
        /// Gets or sets the value of the temperature change in the base unit.
        /// </summary>
        public override double Value
        {
			...
			set{
				throw new NotSupportedException("TemperatureChange Doesn't support base value changing");
			}

        }

		 /// <summary>
        /// Gets if temperature change is variable or not
        /// </summary>
        ...
        public static TemperatureChange Parse(string input, IFormatProvider provider, IUnitProvider unitProvider)
        {
            ...
            {
				return new  TemperatureChange(0);
        ...
        /// </returns>
        public override int CompareTo(TemperatureChange other)
        {
        ...
        /// </returns>
        public override bool Equals(TemperatureChange other)
        {
...
#if MONGO
	public class TemperatureChangeSerializer:SerializerBase<TemperatureChange>{
		public override TemperatureChange Deserialize(BsonDeserializationContext context, BsonDeserializationArgs args)
        {
            var up = UnitProvider.Default;
            IUnit result;
            if(up.TryGetUnit(typeof(TemperatureChange), context.Reader.ReadString(), out result))
                return (TemperatureChange)result;

            return base.Deserialize(context, args);
        } 
	}
#endif
	public enum TemperatureChangeUnit{
		KelvinPerSecond,
