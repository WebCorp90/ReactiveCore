...
// </auto-generated>
// <copyright file="ElectricCurrent.cs" company="Webcorp">
...
#endif
	[DataContract]
	[TypeConverter(typeof(UnitTypeConverter<ElectricCurrent>))]
    public partial class ElectricCurrent : Unit<ElectricCurrent>
    {
        /// <summary>
        ...
        /// </summary>
        public ElectricCurrent():this(0.0)
        {
        ...
        {
            this.value = value;
			registeredSymbols = new List<string>() { "A","mA","µA"};
        }
		...
		//[BsonSerializer(typeof(ElectricCurrentSerializer))]
        ...
        /// <summary>
        /// Gets or sets the value of the electric current in the base unit.
        /// </summary>
        public override double Value
        {
			...
			set{
				throw new NotSupportedException("ElectricCurrent Doesn't support base value changing");
			}

        }

		 /// <summary>
        /// Gets if electric current is variable or not
        /// </summary>
        ...
        /// </returns>
        public override int CompareTo(ElectricCurrent other)
        {
        ...
        /// </returns>
        public override bool Equals(ElectricCurrent other)
        {
...
#if MONGO
	public class ElectricCurrentSerializer:SerializerBase<ElectricCurrent>{
		public override ElectricCurrent Deserialize(BsonDeserializationContext context, BsonDeserializationArgs args)
        {
            var up = UnitProvider.Default;
            IUnit result;
            if(up.TryGetUnit(typeof(ElectricCurrent), context.Reader.ReadString(), out result))
                return (ElectricCurrent)result;
