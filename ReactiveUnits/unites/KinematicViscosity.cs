...
// </auto-generated>
// <copyright file="KinematicViscosity.cs" company="Webcorp">
...
#endif
	[DataContract]
	[TypeConverter(typeof(UnitTypeConverter<KinematicViscosity>))]
    public partial class KinematicViscosity : Unit<KinematicViscosity>
    {
        /// <summary>
        ...
        /// </summary>
        public KinematicViscosity():this(0.0)
        {
        ...
        {
            this.value = value;
			registeredSymbols = new List<string>() { "m^2/s","mm^2/s"};
        }
		...
		//[BsonSerializer(typeof(KinematicViscositySerializer))]
        ...
        /// <summary>
        /// Gets or sets the value of the kinematic viscosity in the base unit.
        /// </summary>
        public override double Value
        {
			...
			set{
				throw new NotSupportedException("KinematicViscosity Doesn't support base value changing");
			}

        }

		 /// <summary>
        /// Gets if kinematic viscosity is variable or not
        /// </summary>
        ...
        public static KinematicViscosity Parse(string input, IFormatProvider provider, IUnitProvider unitProvider)
        {
            ...
            {
				return new  KinematicViscosity(0);
        ...
        /// A <see cref="KinematicViscosity"/> that represents the quantity in <paramref name="input" />. 
        /// </returns>
        public static KinematicViscosity Parse(string input, IUnitProvider unitProvider)
        {
            if (unitProvider == null)
            {
        ...
        public static bool TryParse(string input, IFormatProvider provider, IUnitProvider unitProvider, out KinematicViscosity result)
        {
            if (unitProvider == null)
            {
                unitProvider = provider as IUnitProvider ?? UnitProvider.Default;
        ...
        /// </returns>
        public static KinematicViscosity ParseJson(string input)
        {
        ...
        /// The result of the operator. 
        /// </returns>
        public static KinematicViscosity operator +(KinematicViscosity x)
        {
            return new KinematicViscosity(x.value);
        }
        ...
        /// </returns>
        public override int CompareTo(KinematicViscosity other)
        {
        ...
        /// </returns>
        public override bool Equals(KinematicViscosity other)
        {
...
#if MONGO
	public class KinematicViscositySerializer:SerializerBase<KinematicViscosity>{
		public override KinematicViscosity Deserialize(BsonDeserializationContext context, BsonDeserializationArgs args)
        {
            var up = UnitProvider.Default;
            IUnit result;
            if(up.TryGetUnit(typeof(KinematicViscosity), context.Reader.ReadString(), out result))
                return (KinematicViscosity)result;
