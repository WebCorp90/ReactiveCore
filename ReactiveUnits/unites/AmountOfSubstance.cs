...
// </auto-generated>
// <copyright file="AmountOfSubstance.cs" company="Webcorp">
...
#endif
	[DataContract]
	[TypeConverter(typeof(UnitTypeConverter<AmountOfSubstance>))]
    public partial class AmountOfSubstance : Unit<AmountOfSubstance>
    {
        /// <summary>
        ...
        /// </summary>
        public AmountOfSubstance():this(0.0)
        {
        ...
        {
            this.value = value;
			registeredSymbols = new List<string>() { "mol"};
        }
		...
		//[BsonSerializer(typeof(AmountOfSubstanceSerializer))]
        ...
        /// <summary>
        /// Gets or sets the value of the amount of substance in the base unit.
        /// </summary>
        public override double Value
        {
			...
			set{
				throw new NotSupportedException("AmountOfSubstance Doesn't support base value changing");
			}

        }

		 /// <summary>
        /// Gets if amount of substance is variable or not
        /// </summary>
        ...
        public static AmountOfSubstance Parse(string input, IFormatProvider provider, IUnitProvider unitProvider)
        {
            ...
            {
				return new  AmountOfSubstance(0);
        ...
        /// </returns>
        public override int CompareTo(AmountOfSubstance other)
        {
        ...
        /// </returns>
        public override bool Equals(AmountOfSubstance other)
        {
...
#if MONGO
	public class AmountOfSubstanceSerializer:SerializerBase<AmountOfSubstance>{
		public override AmountOfSubstance Deserialize(BsonDeserializationContext context, BsonDeserializationArgs args)
        {
            var up = UnitProvider.Default;
            IUnit result;
            if(up.TryGetUnit(typeof(AmountOfSubstance), context.Reader.ReadString(), out result))
                return (AmountOfSubstance)result;
