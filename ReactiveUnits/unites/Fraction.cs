...
// </auto-generated>
// <copyright file="Fraction.cs" company="Webcorp">
...
#endif
	[DataContract]
	[TypeConverter(typeof(UnitTypeConverter<Fraction>))]
    public partial class Fraction : Unit<Fraction>
    {
        /// <summary>
        ...
        {
            this.value = value;
			registeredSymbols = new List<string>() { "","%","‰","ppm","ppb"};
        }
		...
		//[BsonSerializer(typeof(FractionSerializer))]
        ...
        /// <summary>
        /// Gets or sets the value of the fraction in the base unit.
        /// </summary>
        public override double Value
        {
			...
			set{
				throw new NotSupportedException("Fraction Doesn't support base value changing");
			}

        }

		 /// <summary>
        /// Gets if fraction is variable or not
        /// </summary>
        ...
        /// A <see cref="Fraction"/> that represents the quantity in <paramref name="input" />. 
        /// </returns>
        public static Fraction Parse(string input, IUnitProvider unitProvider)
        {
            if (unitProvider == null)
            {
        ...
        public static bool TryParse(string input, IFormatProvider provider, IUnitProvider unitProvider, out Fraction result)
        {
            if (unitProvider == null)
            {
                unitProvider = provider as IUnitProvider ?? UnitProvider.Default;
        ...
        /// </returns>
        public static Fraction ParseJson(string input)
        {
        ...
        {
            return new Fraction(x.value + y.value);
        }
        ...
        {
            return this.ConvertTo((Fraction)unit);
        }
        ...
        public override IUnit Add(IUnit x)
        {
            ...
            return new Fraction(this.value + x.Value);
        }
...
#if MONGO
	public class FractionSerializer:SerializerBase<Fraction>{
		public override Fraction Deserialize(BsonDeserializationContext context, BsonDeserializationArgs args)
        {
            var up = UnitProvider.Default;
            IUnit result;
            if(up.TryGetUnit(typeof(Fraction), context.Reader.ReadString(), out result))
