...
// </auto-generated>
// <copyright file="RadiationExposure.cs" company="Webcorp">
...
#endif
	[DataContract]
	[TypeConverter(typeof(UnitTypeConverter<RadiationExposure>))]
    public partial class RadiationExposure : Unit<RadiationExposure>
    {
        /// <summary>
        /// The backing field for the <see cref="Roentgen" /> property.
        /// </summary>
		[Unit("R", true)]
		private static readonly RadiationExposure RoentgenField = new RadiationExposure(2.58e-4);
		...
		/// <summary>
        /// Initializes a new instance of the <see cref="RadiationExposure"/> struct.
        /// </summary>
        public RadiationExposure():this(0.0)
        {
        ...
        /// The value. 
        /// </param>
        public RadiationExposure(double value)
        {
            this.value = value;
			registeredSymbols = new List<string>() { "R"};
        }
        ...
        /// The unit provider. 
        /// </param>
        public RadiationExposure(string value, IUnitProvider unitProvider = null)
        {
		...
		//[BsonSerializer(typeof(RadiationExposureSerializer))]
        ...
        /// <summary>
        /// Gets or sets the value of the radiation exposure in the base unit.
        /// </summary>
        public override double Value
        {
			...
			set{
				throw new NotSupportedException("RadiationExposure Doesn't support base value changing");
			}

        }

		 /// <summary>
        /// Gets if radiation exposure is variable or not
        /// </summary>
        ...
        public static RadiationExposure Parse(string input, IFormatProvider provider, IUnitProvider unitProvider)
        {
            ...
            {
				return new  RadiationExposure(0);
        ...
        /// A <see cref="RadiationExposure"/> that represents the quantity in <paramref name="input" />. 
        /// </returns>
        public static RadiationExposure Parse(string input, IUnitProvider unitProvider)
        {
            if (unitProvider == null)
            {
        ...
        public static bool TryParse(string input, IFormatProvider provider, IUnitProvider unitProvider, out RadiationExposure result)
        {
            if (unitProvider == null)
            {
                unitProvider = provider as IUnitProvider ?? UnitProvider.Default;
        ...
        /// <returns>
        /// The <see cref="RadiationExposure"/> .
        /// </returns>
        public static RadiationExposure ParseJson(string input)
        {
        ...
        /// </returns>
        public static RadiationExposure operator +(RadiationExposure x, RadiationExposure y)
        {
            return new RadiationExposure(x.value + y.value);
        }
        ...
        /// The result of the operator. 
        /// </returns>
        public static RadiationExposure operator /(RadiationExposure x, double y)
        {
            return new RadiationExposure(x.value / y);
        }
        ...
        /// The result of the operator. 
        /// </returns>
        public static double operator /(RadiationExposure x, RadiationExposure y)
        {
        ...
        /// The result of the operator. 
        /// </returns>
        public static bool operator ==(RadiationExposure x, RadiationExposure y)
        {
        ...
        /// The result of the operator. 
        /// </returns>
        public static RadiationExposure operator *(double x, RadiationExposure y)
        {
            return new RadiationExposure(x * y.value);
        }
        ...
        /// The result of the operator. 
        /// </returns>
        public static RadiationExposure operator +(RadiationExposure x)
        {
            return new RadiationExposure(x.value);
        }
        ...
        /// <summary>
        /// Compares this instance to the specified <see cref="RadiationExposure"/> and returns an indication of their relative values.
        /// </summary>
        /// <param name="other">
        /// The other <see cref="RadiationExposure"/> . 
        /// </param>
        /// <returns>
        /// A signed number indicating the relative values of this instance and the other value. 
        /// </returns>
        public override int CompareTo(RadiationExposure other)
        {
        ...
        {
            return this.ConvertTo((RadiationExposure)unit);
        }
        ...
        /// </returns>
        public double ConvertTo(RadiationExposure unit)
        {
        ...
        /// <summary>
        /// Determines if the specified <see cref="RadiationExposure"/> is equal to this instance.
        /// </summary>
        /// <param name="other">
        /// The other <see cref="RadiationExposure"/> . 
        /// </param>
        ...
        /// </returns>
        public override bool Equals(RadiationExposure other)
        {
...
#if MONGO
	public class RadiationExposureSerializer:SerializerBase<RadiationExposure>{
		public override RadiationExposure Deserialize(BsonDeserializationContext context, BsonDeserializationArgs args)
        {
            var up = UnitProvider.Default;
            IUnit result;
            if(up.TryGetUnit(typeof(RadiationExposure), context.Reader.ReadString(), out result))
                return (RadiationExposure)result;
