...
// </auto-generated>
// <copyright file="Pressure.cs" company="Webcorp">
...
namespace Webcorp.unite
{
    ...
    public partial class Pressure : Unit<Pressure>
    {
        ...
        {
            this.value = value;
			registeredSymbols = new List<string>() { "Pa","kPa","psi","ksi","mmHg","bar","Megapascal","atm","inHg","ftH2O","inH2O"};
        }
		...
		//[BsonSerializer(typeof(PressureSerializer))]
        ...
        /// </returns>
        public override int CompareTo(Pressure other)
        {
        ...
        /// </returns>
        public override bool Equals(Pressure other)
        {
	...
	public class PressureSerializer:SerializerBase<Pressure>{
		public override Pressure Deserialize(BsonDeserializationContext context, BsonDeserializationArgs args)
        {
            ...
            IUnit result;
            if(up.TryGetUnit(typeof(Pressure), context.Reader.ReadString(), out result))
