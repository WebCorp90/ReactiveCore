...
// </auto-generated>
// <copyright file="Stiffness.cs" company="Webcorp">
...
#endif
	[DataContract]
	[TypeConverter(typeof(UnitTypeConverter<Stiffness>))]
    public partial class Stiffness : Unit<Stiffness>
    {
        /// <summary>
        /// The backing field for the <see cref="NewtonPerMetre" /> property.
        /// </summary>
		[Unit("N/m", true)]
		private static readonly Stiffness NewtonPerMetreField = new Stiffness(1);
		...
		/// <summary>
        /// Initializes a new instance of the <see cref="Stiffness"/> struct.
        /// </summary>
        public Stiffness():this(0.0)
        {
        ...
        /// The value. 
        /// </param>
        public Stiffness(double value)
        {
            this.value = value;
			registeredSymbols = new List<string>() { "N/m"};
        }
        ...
        /// The unit provider. 
        /// </param>
        public Stiffness(string value, IUnitProvider unitProvider = null)
        {
        ...
        /// </summary>
		[Unit("N/m", true)]
		        public static Stiffness NewtonPerMetre
        {
            get { return NewtonPerMetreField; }
        }
		...
		//[BsonSerializer(typeof(StiffnessSerializer))]
        ...
        /// <summary>
        /// Gets or sets the value of the stiffness in the base unit.
        /// </summary>
        public override double Value
        {
			...
			set{
				throw new NotSupportedException("Stiffness Doesn't support base value changing");
			}

        }

		 /// <summary>
        /// Gets if stiffness is variable or not
        /// </summary>
        ...
        /// A <see cref="Stiffness"/> that represents the quantity in <paramref name="input" />. 
        /// </returns>
        public static Stiffness Parse(string input, IUnitProvider unitProvider)
        {
            if (unitProvider == null)
            {
        ...
        public static bool TryParse(string input, IFormatProvider provider, IUnitProvider unitProvider, out Stiffness result)
        {
            if (unitProvider == null)
            {
                unitProvider = provider as IUnitProvider ?? UnitProvider.Default;
        ...
        /// <returns>
        /// The <see cref="Stiffness"/> .
        /// </returns>
        public static Stiffness ParseJson(string input)
        {
        ...
        /// </returns>
        public static Stiffness operator +(Stiffness x, Stiffness y)
        {
            return new Stiffness(x.value + y.value);
        }
        ...
        /// The result of the operator. 
        /// </returns>
        public static Stiffness operator /(Stiffness x, double y)
        {
            return new Stiffness(x.value / y);
        }
        ...
        /// The result of the operator. 
        /// </returns>
        public static double operator /(Stiffness x, Stiffness y)
        {
        ...
        /// The result of the operator. 
        /// </returns>
        public static bool operator ==(Stiffness x, Stiffness y)
        {
        ...
        /// The result of the operator. 
        /// </returns>
        public static Stiffness operator *(double x, Stiffness y)
        {
            return new Stiffness(x * y.value);
        }
        ...
        /// The result of the operator. 
        /// </returns>
        public static Stiffness operator +(Stiffness x)
        {
            return new Stiffness(x.value);
        }
        ...
        /// <summary>
        /// Compares this instance to the specified <see cref="Stiffness"/> and returns an indication of their relative values.
        /// </summary>
        /// <param name="other">
        /// The other <see cref="Stiffness"/> . 
        /// </param>
        /// <returns>
        /// A signed number indicating the relative values of this instance and the other value. 
        /// </returns>
        public override int CompareTo(Stiffness other)
        {
        ...
        {
            return this.ConvertTo((Stiffness)unit);
        }
        ...
        /// </returns>
        public double ConvertTo(Stiffness unit)
        {
        ...
        /// <summary>
        /// Determines if the specified <see cref="Stiffness"/> is equal to this instance.
        /// </summary>
        /// <param name="other">
        /// The other <see cref="Stiffness"/> . 
        /// </param>
        ...
        /// </returns>
        public override bool Equals(Stiffness other)
        {
        ...
        public override IUnit Add(IUnit x)
        {
            ...
            return new Stiffness(this.value + x.Value);
        }
...
#if MONGO
	public class StiffnessSerializer:SerializerBase<Stiffness>{
		public override Stiffness Deserialize(BsonDeserializationContext context, BsonDeserializationArgs args)
        {
            var up = UnitProvider.Default;
            IUnit result;
            if(up.TryGetUnit(typeof(Stiffness), context.Reader.ReadString(), out result))
