...
// </auto-generated>
// <copyright file="PrecipitationIntensity.cs" company="Webcorp">
...
#endif
	[DataContract]
	[TypeConverter(typeof(UnitTypeConverter<PrecipitationIntensity>))]
    public partial class PrecipitationIntensity : Unit<PrecipitationIntensity>
    {
        /// <summary>
        ...
        /// </summary>
        public PrecipitationIntensity():this(0.0)
        {
        ...
        {
            this.value = value;
			registeredSymbols = new List<string>() { "mm/h","mm/min","mm/s","mm/d","in/h","in/min","in/s","in/d"};
        }
		...
		//[BsonSerializer(typeof(PrecipitationIntensitySerializer))]
        ...
        /// <summary>
        /// Gets or sets the value of the precipitation intensity in the base unit.
        /// </summary>
        public override double Value
        {
		 ...
		 /// <summary>
        /// Gets if precipitation intensity is variable or not
        /// </summary>
        ...
        public static PrecipitationIntensity Parse(string input, IFormatProvider provider, IUnitProvider unitProvider)
        {
            ...
            {
				return new  PrecipitationIntensity(0);
        ...
        /// </returns>
        public override int CompareTo(PrecipitationIntensity other)
        {
        ...
        /// </returns>
        public override bool Equals(PrecipitationIntensity other)
        {
...
#if MONGO
	public class PrecipitationIntensitySerializer:SerializerBase<PrecipitationIntensity>{
		public override PrecipitationIntensity Deserialize(BsonDeserializationContext context, BsonDeserializationArgs args)
        {
            var up = UnitProvider.Default;
            IUnit result;
            if(up.TryGetUnit(typeof(PrecipitationIntensity), context.Reader.ReadString(), out result))
                return (PrecipitationIntensity)result;

            return base.Deserialize(context, args);
        } 
	}
#endif
	public enum PrecipitationIntensityUnit{
		MillimetresPerHour,
