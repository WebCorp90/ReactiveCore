...
// </auto-generated>
// <copyright file="MagneticFluxDensity.cs" company="Webcorp">
...
#endif
	[DataContract]
	[TypeConverter(typeof(UnitTypeConverter<MagneticFluxDensity>))]
    public partial class MagneticFluxDensity : Unit<MagneticFluxDensity>
    {
        /// <summary>
        ...
        /// </summary>
        public MagneticFluxDensity():this(0.0)
        {
        ...
        {
            this.value = value;
			registeredSymbols = new List<string>() { "T"};
        }
		...
		//[BsonSerializer(typeof(MagneticFluxDensitySerializer))]
        ...
        /// <summary>
        /// Gets or sets the value of the magnetic flux density in the base unit.
        /// </summary>
        public override double Value
        {
			...
			set{
				throw new NotSupportedException("MagneticFluxDensity Doesn't support base value changing");
			}

        }

		 /// <summary>
        /// Gets if magnetic flux density is variable or not
        /// </summary>
        ...
        public static MagneticFluxDensity Parse(string input, IFormatProvider provider, IUnitProvider unitProvider)
        {
            ...
            {
				return new  MagneticFluxDensity(0);
        ...
        /// A <see cref="MagneticFluxDensity"/> that represents the quantity in <paramref name="input" />. 
        /// </returns>
        public static MagneticFluxDensity Parse(string input, IUnitProvider unitProvider)
        {
            if (unitProvider == null)
            {
        ...
        public static bool TryParse(string input, IFormatProvider provider, IUnitProvider unitProvider, out MagneticFluxDensity result)
        {
            if (unitProvider == null)
            {
                unitProvider = provider as IUnitProvider ?? UnitProvider.Default;
        ...
        /// </returns>
        public static MagneticFluxDensity ParseJson(string input)
        {
        ...
        /// The result of the operator. 
        /// </returns>
        public static MagneticFluxDensity operator +(MagneticFluxDensity x)
        {
            return new MagneticFluxDensity(x.value);
        }
        ...
        /// </returns>
        public override int CompareTo(MagneticFluxDensity other)
        {
        ...
        {
            return this.CompareTo((MagneticFluxDensity)obj);
        }
        ...
        {
            return this.ConvertTo((MagneticFluxDensity)unit);
        }
        ...
        /// </returns>
        public override bool Equals(MagneticFluxDensity other)
        {
...
#if MONGO
	public class MagneticFluxDensitySerializer:SerializerBase<MagneticFluxDensity>{
		public override MagneticFluxDensity Deserialize(BsonDeserializationContext context, BsonDeserializationArgs args)
        {
            var up = UnitProvider.Default;
            IUnit result;
            if(up.TryGetUnit(typeof(MagneticFluxDensity), context.Reader.ReadString(), out result))
                return (MagneticFluxDensity)result;
