...
// </auto-generated>
// <copyright file="SecondMomentOfArea.cs" company="Webcorp">
...
#endif
	[DataContract]
	[TypeConverter(typeof(UnitTypeConverter<SecondMomentOfArea>))]
    public partial class SecondMomentOfArea : Unit<SecondMomentOfArea>
    {
        /// <summary>
        ...
        /// </summary>
        public SecondMomentOfArea():this(0.0)
        {
        ...
        {
            this.value = value;
			registeredSymbols = new List<string>() { "m^4"};
        }
		...
		//[BsonSerializer(typeof(SecondMomentOfAreaSerializer))]
        ...
        /// <summary>
        /// Gets or sets the value of the second moment of area in the base unit.
        /// </summary>
        public override double Value
        {
			...
			set{
				throw new NotSupportedException("SecondMomentOfArea Doesn't support base value changing");
			}

        }

		 /// <summary>
        /// Gets if second moment of area is variable or not
        /// </summary>
        ...
        public static SecondMomentOfArea Parse(string input, IFormatProvider provider, IUnitProvider unitProvider)
        {
            ...
            {
				return new  SecondMomentOfArea(0);
        ...
        /// A <see cref="SecondMomentOfArea"/> that represents the quantity in <paramref name="input" />. 
        /// </returns>
        public static SecondMomentOfArea Parse(string input, IUnitProvider unitProvider)
        {
            if (unitProvider == null)
            {
        ...
        public static bool TryParse(string input, IFormatProvider provider, IUnitProvider unitProvider, out SecondMomentOfArea result)
        {
            if (unitProvider == null)
            {
                unitProvider = provider as IUnitProvider ?? UnitProvider.Default;
        ...
        /// </returns>
        public static SecondMomentOfArea ParseJson(string input)
        {
        ...
        /// The result of the operator. 
        /// </returns>
        public static SecondMomentOfArea operator +(SecondMomentOfArea x)
        {
            return new SecondMomentOfArea(x.value);
        }
        ...
        /// </returns>
        public override int CompareTo(SecondMomentOfArea other)
        {
        ...
        {
            return this.CompareTo((SecondMomentOfArea)obj);
        }
        ...
        {
            return this.ConvertTo((SecondMomentOfArea)unit);
        }
        ...
        /// </returns>
        public override bool Equals(SecondMomentOfArea other)
        {
...
#if MONGO
	public class SecondMomentOfAreaSerializer:SerializerBase<SecondMomentOfArea>{
		public override SecondMomentOfArea Deserialize(BsonDeserializationContext context, BsonDeserializationArgs args)
        {
            var up = UnitProvider.Default;
            IUnit result;
            if(up.TryGetUnit(typeof(SecondMomentOfArea), context.Reader.ReadString(), out result))
                return (SecondMomentOfArea)result;

            return base.Deserialize(context, args);
        } 
	}
#endif
	public enum SecondMomentOfAreaUnit{
		MetreToTheFourth
	}
