...
// </auto-generated>
// <copyright file="Capacitance.cs" company="Webcorp">
...
#endif
	[DataContract]
	[TypeConverter(typeof(UnitTypeConverter<Capacitance>))]
    public partial class Capacitance : Unit<Capacitance>
    {
        /// <summary>
        ...
        {
            this.value = value;
			registeredSymbols = new List<string>() { "F"};
        }
        ...
        /// The unit provider. 
        /// </param>
        public Capacitance(string value, IUnitProvider unitProvider = null)
        {
		...
		//[BsonSerializer(typeof(CapacitanceSerializer))]
        ...
        /// <summary>
        /// Gets or sets the value of the capacitance in the base unit.
        /// </summary>
        public override double Value
        {
			...
			set{
				throw new NotSupportedException("Capacitance Doesn't support base value changing");
			}

        }

		 /// <summary>
        /// Gets if capacitance is variable or not
        /// </summary>
        ...
        /// A <see cref="Capacitance"/> that represents the quantity in <paramref name="input" />. 
        /// </returns>
        public static Capacitance Parse(string input, IUnitProvider unitProvider)
        {
            if (unitProvider == null)
            {
        ...
        public static bool TryParse(string input, IFormatProvider provider, IUnitProvider unitProvider, out Capacitance result)
        {
            if (unitProvider == null)
            {
                unitProvider = provider as IUnitProvider ?? UnitProvider.Default;
        ...
        /// <returns>
        /// The <see cref="Capacitance"/> .
        /// </returns>
        public static Capacitance ParseJson(string input)
        {
        ...
        {
            return new Capacitance(x.value / y);
        }
        ...
        /// The result of the operator. 
        /// </returns>
        public static double operator /(Capacitance x, Capacitance y)
        {
        ...
        {
            return new Capacitance(x * y.value);
        }
        ...
        /// The result of the operator. 
        /// </returns>
        public static Capacitance operator +(Capacitance x)
        {
            return new Capacitance(x.value);
        }
        ...
        /// <summary>
        /// Compares this instance to the specified <see cref="Capacitance"/> and returns an indication of their relative values.
        /// </summary>
        /// <param name="other">
        /// The other <see cref="Capacitance"/> . 
        /// </param>
        /// <returns>
        /// A signed number indicating the relative values of this instance and the other value. 
        /// </returns>
        public override int CompareTo(Capacitance other)
        {
        ...
        {
            return this.ConvertTo((Capacitance)unit);
        }
        ...
        /// </returns>
        public double ConvertTo(Capacitance unit)
        {
        ...
        /// <summary>
        /// Determines if the specified <see cref="Capacitance"/> is equal to this instance.
        /// </summary>
        /// <param name="other">
        /// The other <see cref="Capacitance"/> . 
        /// </param>
        ...
        /// </returns>
        public override bool Equals(Capacitance other)
        {
        ...
        public override IUnit Add(IUnit x)
        {
            ...
            return new Capacitance(this.value + x.Value);
        }
...
#if MONGO
	public class CapacitanceSerializer:SerializerBase<Capacitance>{
		public override Capacitance Deserialize(BsonDeserializationContext context, BsonDeserializationArgs args)
        {
            var up = UnitProvider.Default;
            IUnit result;
            if(up.TryGetUnit(typeof(Capacitance), context.Reader.ReadString(), out result))
                return (Capacitance)result;
