...
// </auto-generated>
// <copyright file="Acceleration.cs" company="Webcorp">
...
#endif
	[DataContract]
	[TypeConverter(typeof(UnitTypeConverter<Acceleration>))]
    public partial class Acceleration : Unit<Acceleration>
    {
        /// <summary>
        ...
        {
            this.value = value;
			registeredSymbols = new List<string>() { "m/s^2","g","ft/s^2"};
        }
		...
		//[BsonSerializer(typeof(AccelerationSerializer))]
        ...
        /// <summary>
        /// Gets or sets the value of the acceleration in the base unit.
        /// </summary>
        public override double Value
        {
			...
			set{
				throw new NotSupportedException("Acceleration Doesn't support base value changing");
			}

        }

		 /// <summary>
        /// Gets if acceleration is variable or not
        /// </summary>
        ...
        /// A <see cref="Acceleration"/> that represents the quantity in <paramref name="input" />. 
        /// </returns>
        public static Acceleration Parse(string input, IUnitProvider unitProvider)
        {
            if (unitProvider == null)
            {
        ...
        public static bool TryParse(string input, IFormatProvider provider, IUnitProvider unitProvider, out Acceleration result)
        {
            if (unitProvider == null)
            {
                unitProvider = provider as IUnitProvider ?? UnitProvider.Default;
        ...
        /// </returns>
        public static Acceleration ParseJson(string input)
        {
        ...
        {
            return new Acceleration(x.value / y);
        }
        ...
        {
            return new Acceleration(x * y.value);
        }
        ...
        /// The result of the operator. 
        /// </returns>
        public static Acceleration operator +(Acceleration x)
        {
        ...
        /// </returns>
        public override int CompareTo(Acceleration other)
        {
        ...
        {
            return this.CompareTo((Acceleration)obj);
        }
        ...
        {
            return this.ConvertTo((Acceleration)unit);
        }
        ...
        /// </returns>
        public override bool Equals(Acceleration other)
        {
...
#if MONGO
	public class AccelerationSerializer:SerializerBase<Acceleration>{
		public override Acceleration Deserialize(BsonDeserializationContext context, BsonDeserializationArgs args)
        {
            ...
            IUnit result;
            if(up.TryGetUnit(typeof(Acceleration), context.Reader.ReadString(), out result))
