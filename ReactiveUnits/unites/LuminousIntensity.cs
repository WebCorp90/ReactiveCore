...
namespace Webcorp.unite
{
    ...
    public partial class LuminousIntensity : Unit<LuminousIntensity>
    {
        ...
        /// <summary>
        /// Gets or sets the value of the luminous intensity in the base unit.
        /// </summary>
        public override double Value
        {
			...
			set{
				throw new NotSupportedException("LuminousIntensity Doesn't support base value changing");
			}

        }

		 /// <summary>
        /// Gets if luminous intensity is variable or not
        /// </summary>
