...
// </auto-generated>
// <copyright file="DynamicViscosity.cs" company="Webcorp">
...
namespace Webcorp.unite
{
    ...
    public partial class DynamicViscosity : Unit<DynamicViscosity>
    {
        ...
        /// </summary>
        public DynamicViscosity():this(0.0)
        {
        ...
        {
            this.value = value;
			registeredSymbols = new List<string>() { "Pa*s","N*s"};
        }
        ...
        /// The unit provider. 
        /// </param>
        public DynamicViscosity(string value, IUnitProvider unitProvider = null)
        {
		...
		//[BsonSerializer(typeof(DynamicViscositySerializer))]
        ...
        public override double Value
        {
			...
			set{
				throw new NotSupportedException("DynamicViscosity Doesn't support base value changing");
			}
        ...
        /// A <see cref="DynamicViscosity"/> that represents the quantity in <paramref name="input" />. 
        /// </returns>
        public static DynamicViscosity Parse(string input, IUnitProvider unitProvider)
        {
            if (unitProvider == null)
            {
        ...
        public static bool TryParse(string input, IFormatProvider provider, IUnitProvider unitProvider, out DynamicViscosity result)
        {
            if (unitProvider == null)
            {
                unitProvider = provider as IUnitProvider ?? UnitProvider.Default;
        ...
        /// <returns>
        /// The <see cref="DynamicViscosity"/> .
        /// </returns>
        public static DynamicViscosity ParseJson(string input)
        {
        ...
        /// </returns>
        public static DynamicViscosity operator +(DynamicViscosity x, DynamicViscosity y)
        {
            return new DynamicViscosity(x.value + y.value);
        }
        ...
        /// The result of the operator. 
        /// </returns>
        public static DynamicViscosity operator /(DynamicViscosity x, double y)
        {
            return new DynamicViscosity(x.value / y);
        }
        ...
        /// The result of the operator. 
        /// </returns>
        public static double operator /(DynamicViscosity x, DynamicViscosity y)
        {
        ...
        /// The result of the operator. 
        /// </returns>
        public static bool operator ==(DynamicViscosity x, DynamicViscosity y)
        {
        ...
        /// The result of the operator. 
        /// </returns>
        public static DynamicViscosity operator *(double x, DynamicViscosity y)
        {
            return new DynamicViscosity(x * y.value);
        }
        ...
        /// The result of the operator. 
        /// </returns>
        public static DynamicViscosity operator +(DynamicViscosity x)
        {
            return new DynamicViscosity(x.value);
        }
        ...
        /// <summary>
        /// Compares this instance to the specified <see cref="DynamicViscosity"/> and returns an indication of their relative values.
        /// </summary>
        /// <param name="other">
        /// The other <see cref="DynamicViscosity"/> . 
        /// </param>
        /// <returns>
        /// A signed number indicating the relative values of this instance and the other value. 
        /// </returns>
        public override int CompareTo(DynamicViscosity other)
        {
        ...
        {
            return this.CompareTo((DynamicViscosity)obj);
        }
        ...
        {
            return this.ConvertTo((DynamicViscosity)unit);
        }
        ...
        /// </returns>
        public double ConvertTo(DynamicViscosity unit)
        {
        ...
        /// <summary>
        /// Determines if the specified <see cref="DynamicViscosity"/> is equal to this instance.
        /// </summary>
        /// <param name="other">
        /// The other <see cref="DynamicViscosity"/> . 
        /// </param>
        ...
        /// </returns>
        public override bool Equals(DynamicViscosity other)
        {
	...
	public class DynamicViscositySerializer:SerializerBase<DynamicViscosity>{
		public override DynamicViscosity Deserialize(BsonDeserializationContext context, BsonDeserializationArgs args)
        {
            ...
            IUnit result;
            if(up.TryGetUnit(typeof(DynamicViscosity), context.Reader.ReadString(), out result))
                return (DynamicViscosity)result;
