...
// </auto-generated>
// <copyright file="Area.cs" company="Webcorp">
...
#endif
	[DataContract]
	[TypeConverter(typeof(UnitTypeConverter<Area>))]
    public partial class Area : Unit<Area>
    {
        /// <summary>
        ...
        {
            this.value = value;
			registeredSymbols = new List<string>() { "m^2","ac","ha","ft^2","mi^2","km^2"};
        }
        ...
        /// The unit provider. 
        /// </param>
        public Area(string value, IUnitProvider unitProvider = null)
        {
		...
		//[BsonSerializer(typeof(AreaSerializer))]
        ...
        /// <summary>
        /// Gets or sets the value of the area in the base unit.
        /// </summary>
        public override double Value
        {
			...
			set{
				throw new NotSupportedException("Area Doesn't support base value changing");
			}

        }

		 /// <summary>
        /// Gets if area is variable or not
        /// </summary>
        ...
        /// A <see cref="Area"/> that represents the quantity in <paramref name="input" />. 
        /// </returns>
        public static Area Parse(string input, IUnitProvider unitProvider)
        {
            if (unitProvider == null)
            {
        ...
        public static bool TryParse(string input, IFormatProvider provider, IUnitProvider unitProvider, out Area result)
        {
            if (unitProvider == null)
            {
                unitProvider = provider as IUnitProvider ?? UnitProvider.Default;
        ...
        /// The <see cref="Area"/> .
        /// </returns>
        public static Area ParseJson(string input)
        {
        ...
        /// The result of the operator. 
        /// </returns>
        public static double operator /(Area x, Area y)
        {
        ...
        /// The result of the operator. 
        /// </returns>
        public static Area operator +(Area x)
        {
        ...
        /// <summary>
        /// Compares this instance to the specified <see cref="Area"/> and returns an indication of their relative values.
        /// </summary>
        /// <param name="other">
        /// The other <see cref="Area"/> . 
        /// </param>
        /// <returns>
        /// A signed number indicating the relative values of this instance and the other value. 
        /// </returns>
        public override int CompareTo(Area other)
        {
        ...
        {
            return this.ConvertTo((Area)unit);
        }
        ...
        /// </returns>
        public double ConvertTo(Area unit)
        {
        ...
        /// <summary>
        /// Determines if the specified <see cref="Area"/> is equal to this instance.
        /// </summary>
        /// <param name="other">
        /// The other <see cref="Area"/> . 
        /// </param>
        ...
        /// </returns>
        public override bool Equals(Area other)
        {
        ...
        public override IUnit Add(IUnit x)
        {
            ...
            return new Area(this.value + x.Value);
        }
...
#if MONGO
	public class AreaSerializer:SerializerBase<Area>{
		public override Area Deserialize(BsonDeserializationContext context, BsonDeserializationArgs args)
        {
            var up = UnitProvider.Default;
            IUnit result;
            if(up.TryGetUnit(typeof(Area), context.Reader.ReadString(), out result))
                return (Area)result;
