...
// </auto-generated>
// <copyright file="RadiationAbsorbedDose.cs" company="Webcorp">
...
#endif
	[DataContract]
	[TypeConverter(typeof(UnitTypeConverter<RadiationAbsorbedDose>))]
    public partial class RadiationAbsorbedDose : Unit<RadiationAbsorbedDose>
    {
        /// <summary>
        ...
        /// </summary>
        public RadiationAbsorbedDose():this(0.0)
        {
        ...
        {
            this.value = value;
			registeredSymbols = new List<string>() { "Gy"};
        }
		...
		//[BsonSerializer(typeof(RadiationAbsorbedDoseSerializer))]
        ...
        /// <summary>
        /// Gets or sets the value of the radiation absorbed dose in the base unit.
        /// </summary>
        public override double Value
        {
			...
			set{
				throw new NotSupportedException("RadiationAbsorbedDose Doesn't support base value changing");
			}

        }

		 /// <summary>
        /// Gets if radiation absorbed dose is variable or not
        /// </summary>
        ...
        public static RadiationAbsorbedDose Parse(string input, IFormatProvider provider, IUnitProvider unitProvider)
        {
            ...
            {
				return new  RadiationAbsorbedDose(0);
        ...
        /// </returns>
        public override int CompareTo(RadiationAbsorbedDose other)
        {
        ...
        /// </returns>
        public override bool Equals(RadiationAbsorbedDose other)
        {
...
#if MONGO
	public class RadiationAbsorbedDoseSerializer:SerializerBase<RadiationAbsorbedDose>{
		public override RadiationAbsorbedDose Deserialize(BsonDeserializationContext context, BsonDeserializationArgs args)
        {
            var up = UnitProvider.Default;
            IUnit result;
            if(up.TryGetUnit(typeof(RadiationAbsorbedDose), context.Reader.ReadString(), out result))
                return (RadiationAbsorbedDose)result;

            return base.Deserialize(context, args);
        } 
	}
#endif
	public enum RadiationAbsorbedDoseUnit{
		Gray
	}
