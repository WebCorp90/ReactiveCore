...
namespace Webcorp.unite
{
    ...
    public partial class Velocity : Unit<Velocity>
    {
        ...
        /// <summary>
        /// Gets or sets the value of the velocity in the base unit.
        /// </summary>
        public override double Value
        {
			...
			set{
				throw new NotSupportedException("Velocity Doesn't support base value changing");
			}

        }

		 /// <summary>
        /// Gets if velocity is variable or not
        /// </summary>
