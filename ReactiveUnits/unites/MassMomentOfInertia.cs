...
// </auto-generated>
// <copyright file="MassMomentOfInertia.cs" company="Webcorp">
...
namespace Webcorp.unite
{
    ...
    public partial class MassMomentOfInertia : Unit<MassMomentOfInertia>
    {
        ...
        /// </summary>
        public MassMomentOfInertia():this(0.0)
        {
        ...
        {
            this.value = value;
			registeredSymbols = new List<string>() { "kg*m^2","lb*in^2","lb*ft^2","lbf*in*s^2"};
        }
		...
		//[BsonSerializer(typeof(MassMomentOfInertiaSerializer))]
        ...
        public override double Value
        {
			...
			set{
				throw new NotSupportedException("MassMomentOfInertia Doesn't support base value changing");
			}
        ...
        public static MassMomentOfInertia Parse(string input, IFormatProvider provider, IUnitProvider unitProvider)
        {
            ...
            {
				return new  MassMomentOfInertia(0);
        ...
        /// A <see cref="MassMomentOfInertia"/> that represents the quantity in <paramref name="input" />. 
        /// </returns>
        public static MassMomentOfInertia Parse(string input, IUnitProvider unitProvider)
        {
            if (unitProvider == null)
            {
        ...
        public static bool TryParse(string input, IFormatProvider provider, IUnitProvider unitProvider, out MassMomentOfInertia result)
        {
            if (unitProvider == null)
            {
                unitProvider = provider as IUnitProvider ?? UnitProvider.Default;
        ...
        /// </returns>
        public static MassMomentOfInertia ParseJson(string input)
        {
        ...
        /// </returns>
        public override int CompareTo(MassMomentOfInertia other)
        {
        ...
        /// </returns>
        public override bool Equals(MassMomentOfInertia other)
        {
	...
	public class MassMomentOfInertiaSerializer:SerializerBase<MassMomentOfInertia>{
		public override MassMomentOfInertia Deserialize(BsonDeserializationContext context, BsonDeserializationArgs args)
        {
            ...
            IUnit result;
            if(up.TryGetUnit(typeof(MassMomentOfInertia), context.Reader.ReadString(), out result))
                return (MassMomentOfInertia)result;
