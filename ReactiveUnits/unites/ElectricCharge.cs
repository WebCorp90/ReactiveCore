...
namespace Webcorp.unite
{
    ...
    public partial class ElectricCharge : Unit<ElectricCharge>
    {
        ...
        /// <summary>
        /// Gets or sets the value of the electric charge in the base unit.
        /// </summary>
        public override double Value
        {
			...
			set{
				throw new NotSupportedException("ElectricCharge Doesn't support base value changing");
			}

        }

		 /// <summary>
        /// Gets if electric charge is variable or not
        /// </summary>
