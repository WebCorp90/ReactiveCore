...
// </auto-generated>
// <copyright file="Illuminance.cs" company="Webcorp">
...
#endif
	[DataContract]
	[TypeConverter(typeof(UnitTypeConverter<Illuminance>))]
    public partial class Illuminance : Unit<Illuminance>
    {
        /// <summary>
        ...
        {
            this.value = value;
			registeredSymbols = new List<string>() { "lx"};
        }
		...
		//[BsonSerializer(typeof(IlluminanceSerializer))]
        ...
        /// <summary>
        /// Gets or sets the value of the illuminance in the base unit.
        /// </summary>
        public override double Value
        {
			...
			set{
				throw new NotSupportedException("Illuminance Doesn't support base value changing");
			}

        }

		 /// <summary>
        /// Gets if illuminance is variable or not
        /// </summary>
        ...
        /// A <see cref="Illuminance"/> that represents the quantity in <paramref name="input" />. 
        /// </returns>
        public static Illuminance Parse(string input, IUnitProvider unitProvider)
        {
            if (unitProvider == null)
            {
        ...
        public static bool TryParse(string input, IFormatProvider provider, IUnitProvider unitProvider, out Illuminance result)
        {
            if (unitProvider == null)
            {
                unitProvider = provider as IUnitProvider ?? UnitProvider.Default;
        ...
        /// </returns>
        public static Illuminance ParseJson(string input)
        {
        ...
        /// The result of the operator. 
        /// </returns>
        public static Illuminance operator +(Illuminance x)
        {
            return new Illuminance(x.value);
        }
        ...
        /// </returns>
        public override int CompareTo(Illuminance other)
        {
        ...
        {
            return this.CompareTo((Illuminance)obj);
        }
        ...
        /// </returns>
        public override bool Equals(Illuminance other)
        {
        ...
        public override IUnit Add(IUnit x)
        {
            ...
            return new Illuminance(this.value + x.Value);
        }
...
#if MONGO
	public class IlluminanceSerializer:SerializerBase<Illuminance>{
		public override Illuminance Deserialize(BsonDeserializationContext context, BsonDeserializationArgs args)
        {
            var up = UnitProvider.Default;
            IUnit result;
            if(up.TryGetUnit(typeof(Illuminance), context.Reader.ReadString(), out result))
