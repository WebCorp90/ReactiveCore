...
// </auto-generated>
// <copyright file="HeatCapacity.cs" company="Webcorp">
...
#endif
	[DataContract]
	[TypeConverter(typeof(UnitTypeConverter<HeatCapacity>))]
    public partial class HeatCapacity : Unit<HeatCapacity>
    {
        /// <summary>
        ...
        {
            this.value = value;
			registeredSymbols = new List<string>() { "J/K"};
        }
		...
		//[BsonSerializer(typeof(HeatCapacitySerializer))]
        ...
        /// <summary>
        /// Gets or sets the value of the heat capacity in the base unit.
        /// </summary>
        public override double Value
        {
		 ...
		 /// <summary>
        /// Gets if heat capacity is variable or not
        /// </summary>
        ...
        /// A <see cref="HeatCapacity"/> that represents the quantity in <paramref name="input" />. 
        /// </returns>
        public static HeatCapacity Parse(string input, IUnitProvider unitProvider)
        {
            if (unitProvider == null)
            {
        ...
        public static bool TryParse(string input, IFormatProvider provider, IUnitProvider unitProvider, out HeatCapacity result)
        {
            if (unitProvider == null)
            {
                unitProvider = provider as IUnitProvider ?? UnitProvider.Default;
        ...
        /// </returns>
        public static HeatCapacity ParseJson(string input)
        {
        ...
        /// The result of the operator. 
        /// </returns>
        public static HeatCapacity operator +(HeatCapacity x)
        {
            return new HeatCapacity(x.value);
        }
        ...
        /// </returns>
        public override int CompareTo(HeatCapacity other)
        {
        ...
        {
            return this.CompareTo((HeatCapacity)obj);
        }
        ...
        {
            return this.ConvertTo((HeatCapacity)unit);
        }
        ...
        /// </returns>
        public override bool Equals(HeatCapacity other)
        {
...
#if MONGO
	public class HeatCapacitySerializer:SerializerBase<HeatCapacity>{
		public override HeatCapacity Deserialize(BsonDeserializationContext context, BsonDeserializationArgs args)
        {
            var up = UnitProvider.Default;
            IUnit result;
            if(up.TryGetUnit(typeof(HeatCapacity), context.Reader.ReadString(), out result))
                return (HeatCapacity)result;
