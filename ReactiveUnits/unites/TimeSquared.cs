...
// </auto-generated>
// <copyright file="TimeSquared.cs" company="Webcorp">
...
#endif
	[DataContract]
	[TypeConverter(typeof(UnitTypeConverter<TimeSquared>))]
    public partial class TimeSquared : Unit<TimeSquared>
    {
        /// <summary>
        /// The backing field for the <see cref="SecondSquared" /> property.
        /// </summary>
		[Unit("s^2", true)]
		private static readonly TimeSquared SecondSquaredField = new TimeSquared(1);
		...
		/// <summary>
        /// Initializes a new instance of the <see cref="TimeSquared"/> struct.
        /// </summary>
        public TimeSquared():this(0.0)
        {
        ...
        /// The value. 
        /// </param>
        public TimeSquared(double value)
        {
            this.value = value;
			registeredSymbols = new List<string>() { "s^2"};
        }
        ...
        /// The unit provider. 
        /// </param>
        public TimeSquared(string value, IUnitProvider unitProvider = null)
        {
        ...
        /// </summary>
		[Unit("s^2", true)]
		        public static TimeSquared SecondSquared
        {
            get { return SecondSquaredField; }
        }
		...
		//[BsonSerializer(typeof(TimeSquaredSerializer))]
        ...
        /// <summary>
        /// Gets or sets the value of the time squared in the base unit.
        /// </summary>
        public override double Value
        {
			...
			set{
				throw new NotSupportedException("TimeSquared Doesn't support base value changing");
			}

        }

		 /// <summary>
        /// Gets if time squared is variable or not
        /// </summary>
        ...
        /// A <see cref="TimeSquared"/> that represents the quantity in <paramref name="input" />. 
        /// </returns>
        public static TimeSquared Parse(string input, IUnitProvider unitProvider)
        {
            if (unitProvider == null)
            {
        ...
        public static bool TryParse(string input, IFormatProvider provider, IUnitProvider unitProvider, out TimeSquared result)
        {
            if (unitProvider == null)
            {
                unitProvider = provider as IUnitProvider ?? UnitProvider.Default;
        ...
        /// <returns>
        /// The <see cref="TimeSquared"/> .
        /// </returns>
        public static TimeSquared ParseJson(string input)
        {
        ...
        /// </returns>
        public static TimeSquared operator +(TimeSquared x, TimeSquared y)
        {
        ...
        /// The result of the operator. 
        /// </returns>
        public static TimeSquared operator /(TimeSquared x, double y)
        {
            return new TimeSquared(x.value / y);
        }
        ...
        /// The result of the operator. 
        /// </returns>
        public static double operator /(TimeSquared x, TimeSquared y)
        {
        ...
        /// The result of the operator. 
        /// </returns>
        public static bool operator ==(TimeSquared x, TimeSquared y)
        {
        ...
        /// The result of the operator. 
        /// </returns>
        public static TimeSquared operator *(double x, TimeSquared y)
        {
            return new TimeSquared(x * y.value);
        }
        ...
        /// The result of the operator. 
        /// </returns>
        public static TimeSquared operator +(TimeSquared x)
        {
            return new TimeSquared(x.value);
        }
        ...
        /// <summary>
        /// Compares this instance to the specified <see cref="TimeSquared"/> and returns an indication of their relative values.
        /// </summary>
        /// <param name="other">
        /// The other <see cref="TimeSquared"/> . 
        /// </param>
        /// <returns>
        /// A signed number indicating the relative values of this instance and the other value. 
        /// </returns>
        public override int CompareTo(TimeSquared other)
        {
        ...
        {
            return this.CompareTo((TimeSquared)obj);
        }
        ...
        {
            return this.ConvertTo((TimeSquared)unit);
        }
        ...
        /// </returns>
        public double ConvertTo(TimeSquared unit)
        {
        ...
        {
            if (obj is TimeSquared)
            {
                return this.Equals((TimeSquared)obj);
            }
        ...
        /// <summary>
        /// Determines if the specified <see cref="TimeSquared"/> is equal to this instance.
        /// </summary>
        /// <param name="other">
        /// The other <see cref="TimeSquared"/> . 
        /// </param>
        ...
        /// </returns>
        public override bool Equals(TimeSquared other)
        {
        ...
        public override IUnit Add(IUnit x)
        {
            ...
            return new TimeSquared(this.value + x.Value);
        }
...
#if MONGO
	public class TimeSquaredSerializer:SerializerBase<TimeSquared>{
		public override TimeSquared Deserialize(BsonDeserializationContext context, BsonDeserializationArgs args)
        {
            var up = UnitProvider.Default;
            IUnit result;
            if(up.TryGetUnit(typeof(TimeSquared), context.Reader.ReadString(), out result))
                return (TimeSquared)result;

            return base.Deserialize(context, args);
        } 
	}
#endif
	public enum TimeSquaredUnit{
		SecondSquared
	}
