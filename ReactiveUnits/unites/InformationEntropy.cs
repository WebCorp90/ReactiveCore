...
// </auto-generated>
// <copyright file="InformationEntropy.cs" company="Webcorp">
...
#endif
	[DataContract]
	[TypeConverter(typeof(UnitTypeConverter<InformationEntropy>))]
    public partial class InformationEntropy : Unit<InformationEntropy>
    {
        /// <summary>
        ...
        /// </summary>
        public InformationEntropy():this(0.0)
        {
        ...
        {
            this.value = value;
			registeredSymbols = new List<string>() { "J/K","B"};
        }
		...
		//[BsonSerializer(typeof(InformationEntropySerializer))]
        ...
        /// <summary>
        /// Gets or sets the value of the information entropy in the base unit.
        /// </summary>
        public override double Value
        {
			...
			set{
				throw new NotSupportedException("InformationEntropy Doesn't support base value changing");
			}

        }

		 /// <summary>
        /// Gets if information entropy is variable or not
        /// </summary>
        ...
        public static InformationEntropy Parse(string input, IFormatProvider provider, IUnitProvider unitProvider)
        {
            ...
            {
				return new  InformationEntropy(0);
        ...
        /// The result of the operator. 
        /// </returns>
        public static InformationEntropy operator +(InformationEntropy x)
        {
            return new InformationEntropy(x.value);
        }
        ...
        /// </returns>
        public override int CompareTo(InformationEntropy other)
        {
        ...
        /// </returns>
        public override bool Equals(InformationEntropy other)
        {
...
#if MONGO
	public class InformationEntropySerializer:SerializerBase<InformationEntropy>{
		public override InformationEntropy Deserialize(BsonDeserializationContext context, BsonDeserializationArgs args)
        {
            var up = UnitProvider.Default;
            IUnit result;
            if(up.TryGetUnit(typeof(InformationEntropy), context.Reader.ReadString(), out result))
                return (InformationEntropy)result;

            return base.Deserialize(context, args);
        } 
	}
#endif
	public enum InformationEntropyUnit{
		JoulePerKelvin,
Byte
	}
