...
// </auto-generated>
// <copyright file="FuelEconomy.cs" company="Webcorp">
...
#endif
	[DataContract]
	[TypeConverter(typeof(UnitTypeConverter<FuelEconomy>))]
    public partial class FuelEconomy : Unit<FuelEconomy>
    {
        /// <summary>
        ...
        {
            this.value = value;
			registeredSymbols = new List<string>() { "km/l","mpg"};
        }
		...
		//[BsonSerializer(typeof(FuelEconomySerializer))]
        ...
        /// <summary>
        /// Gets or sets the value of the fuel economy in the base unit.
        /// </summary>
        public override double Value
        {
		 ...
		 /// <summary>
        /// Gets if fuel economy is variable or not
        /// </summary>
        ...
        /// A <see cref="FuelEconomy"/> that represents the quantity in <paramref name="input" />. 
        /// </returns>
        public static FuelEconomy Parse(string input, IUnitProvider unitProvider)
        {
            if (unitProvider == null)
            {
        ...
        /// The result of the operator. 
        /// </returns>
        public static FuelEconomy operator +(FuelEconomy x)
        {
            return new FuelEconomy(x.value);
        }
        ...
        /// </returns>
        public override int CompareTo(FuelEconomy other)
        {
        ...
        {
            return this.CompareTo((FuelEconomy)obj);
        }
        ...
        {
            return this.ConvertTo((FuelEconomy)unit);
        }
        ...
        /// </returns>
        public override bool Equals(FuelEconomy other)
        {
        ...
        public override IUnit Add(IUnit x)
        {
            ...
            return new FuelEconomy(this.value + x.Value);
        }
...
#if MONGO
	public class FuelEconomySerializer:SerializerBase<FuelEconomy>{
		public override FuelEconomy Deserialize(BsonDeserializationContext context, BsonDeserializationArgs args)
        {
            var up = UnitProvider.Default;
            IUnit result;
            if(up.TryGetUnit(typeof(FuelEconomy), context.Reader.ReadString(), out result))
                return (FuelEconomy)result;
