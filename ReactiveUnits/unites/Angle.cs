...
namespace Webcorp.unite
{
    ...
    public partial class Angle : Unit<Angle>
    {
        ...
        /// <summary>
        /// Gets or sets the value of the angle in the base unit.
        /// </summary>
        public override double Value
        {
			...
			set{
				throw new NotSupportedException("Angle Doesn't support base value changing");
			}

        }

		 /// <summary>
        /// Gets if angle is variable or not
        /// </summary>
