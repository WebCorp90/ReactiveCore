...
// </auto-generated>
// <copyright file="Torque.cs" company="Webcorp">
...
#endif
	[DataContract]
	[TypeConverter(typeof(UnitTypeConverter<Torque>))]
    public partial class Torque : Unit<Torque>
    {
        /// <summary>
		...
		//[BsonSerializer(typeof(TorqueSerializer))]
        ...
        /// <summary>
        /// Gets or sets the value of the torque in the base unit.
        /// </summary>
        public override double Value
        {
			...
			set{
				throw new NotSupportedException("Torque Doesn't support base value changing");
			}

        }

		 /// <summary>
        /// Gets if torque is variable or not
        /// </summary>
        ...
        /// A <see cref="Torque"/> that represents the quantity in <paramref name="input" />. 
        /// </returns>
        public static Torque Parse(string input, IUnitProvider unitProvider)
        {
            if (unitProvider == null)
            {
        ...
        public static bool TryParse(string input, IFormatProvider provider, IUnitProvider unitProvider, out Torque result)
        {
            if (unitProvider == null)
            {
                unitProvider = provider as IUnitProvider ?? UnitProvider.Default;
        ...
        /// The <see cref="Torque"/> .
        /// </returns>
        public static Torque ParseJson(string input)
        {
        ...
        /// The result of the operator. 
        /// </returns>
        public static Torque operator +(Torque x)
        {
            return new Torque(x.value);
        }
        ...
        /// </returns>
        public override int CompareTo(Torque other)
        {
        ...
        /// </returns>
        public override bool Equals(Torque other)
        {
        ...
        public override IUnit Add(IUnit x)
        {
            ...
            return new Torque(this.value + x.Value);
        }
...
#if MONGO
	public class TorqueSerializer:SerializerBase<Torque>{
		public override Torque Deserialize(BsonDeserializationContext context, BsonDeserializationArgs args)
        {
            var up = UnitProvider.Default;
            IUnit result;
            if(up.TryGetUnit(typeof(Torque), context.Reader.ReadString(), out result))
