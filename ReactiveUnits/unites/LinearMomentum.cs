...
// </auto-generated>
// <copyright file="LinearMomentum.cs" company="Webcorp">
...
#endif
	[DataContract]
	[TypeConverter(typeof(UnitTypeConverter<LinearMomentum>))]
    public partial class LinearMomentum : Unit<LinearMomentum>
    {
        /// <summary>
        ...
        /// </summary>
        public LinearMomentum():this(0.0)
        {
        ...
        /// The value. 
        /// </param>
        public LinearMomentum(double value)
        {
            this.value = value;
			registeredSymbols = new List<string>() { "kg*m/s","N*s"};
        }
        ...
        /// The unit provider. 
        /// </param>
        public LinearMomentum(string value, IUnitProvider unitProvider = null)
        {
		...
		//[BsonSerializer(typeof(LinearMomentumSerializer))]
        ...
        /// <summary>
        /// Gets or sets the value of the linear momentum in the base unit.
        /// </summary>
        public override double Value
        {
			...
			set{
				throw new NotSupportedException("LinearMomentum Doesn't support base value changing");
			}

        }

		 /// <summary>
        /// Gets if linear momentum is variable or not
        /// </summary>
        ...
        /// A <see cref="LinearMomentum"/> that represents the quantity in <paramref name="input" />. 
        /// </returns>
        public static LinearMomentum Parse(string input, IUnitProvider unitProvider)
        {
            if (unitProvider == null)
            {
        ...
        /// <returns>
        /// The <see cref="LinearMomentum"/> .
        /// </returns>
        public static LinearMomentum ParseJson(string input)
        {
        ...
        /// </returns>
        public static LinearMomentum operator +(LinearMomentum x, LinearMomentum y)
        {
            return new LinearMomentum(x.value + y.value);
        }
        ...
        /// The result of the operator. 
        /// </returns>
        public static LinearMomentum operator /(LinearMomentum x, double y)
        {
            return new LinearMomentum(x.value / y);
        }
        ...
        /// The result of the operator. 
        /// </returns>
        public static double operator /(LinearMomentum x, LinearMomentum y)
        {
        ...
        /// The result of the operator. 
        /// </returns>
        public static bool operator ==(LinearMomentum x, LinearMomentum y)
        {
        ...
        /// The result of the operator. 
        /// </returns>
        public static LinearMomentum operator *(double x, LinearMomentum y)
        {
            return new LinearMomentum(x * y.value);
        }
        ...
        /// The result of the operator. 
        /// </returns>
        public static LinearMomentum operator +(LinearMomentum x)
        {
            return new LinearMomentum(x.value);
        }
        ...
        /// <summary>
        /// Compares this instance to the specified <see cref="LinearMomentum"/> and returns an indication of their relative values.
        /// </summary>
        /// <param name="other">
        /// The other <see cref="LinearMomentum"/> . 
        /// </param>
        /// <returns>
        /// A signed number indicating the relative values of this instance and the other value. 
        /// </returns>
        public override int CompareTo(LinearMomentum other)
        {
        ...
        {
            return this.CompareTo((LinearMomentum)obj);
        }
        ...
        {
            return this.ConvertTo((LinearMomentum)unit);
        }
        ...
        /// </returns>
        public double ConvertTo(LinearMomentum unit)
        {
        ...
        /// <summary>
        /// Determines if the specified <see cref="LinearMomentum"/> is equal to this instance.
        /// </summary>
        /// <param name="other">
        /// The other <see cref="LinearMomentum"/> . 
        /// </param>
        ...
        /// </returns>
        public override bool Equals(LinearMomentum other)
        {
...
#if MONGO
	public class LinearMomentumSerializer:SerializerBase<LinearMomentum>{
		public override LinearMomentum Deserialize(BsonDeserializationContext context, BsonDeserializationArgs args)
        {
            var up = UnitProvider.Default;
            IUnit result;
            if(up.TryGetUnit(typeof(LinearMomentum), context.Reader.ReadString(), out result))
                return (LinearMomentum)result;

            return base.Deserialize(context, args);
        } 
	}
#endif
	public enum LinearMomentumUnit{
