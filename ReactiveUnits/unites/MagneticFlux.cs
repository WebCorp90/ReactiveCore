...
// </auto-generated>
// <copyright file="MagneticFlux.cs" company="Webcorp">
...
#endif
	[DataContract]
	[TypeConverter(typeof(UnitTypeConverter<MagneticFlux>))]
    public partial class MagneticFlux : Unit<MagneticFlux>
    {
        /// <summary>
        ...
        {
            this.value = value;
			registeredSymbols = new List<string>() { "Wb","Mx"};
        }
		...
		//[BsonSerializer(typeof(MagneticFluxSerializer))]
        ...
        /// <summary>
        /// Gets or sets the value of the magnetic flux in the base unit.
        /// </summary>
        public override double Value
        {
			...
			set{
				throw new NotSupportedException("MagneticFlux Doesn't support base value changing");
			}

        }

		 /// <summary>
        /// Gets if magnetic flux is variable or not
        /// </summary>
        ...
        /// </returns>
        public override int CompareTo(MagneticFlux other)
        {
        ...
        /// </returns>
        public override bool Equals(MagneticFlux other)
        {
...
#if MONGO
	public class MagneticFluxSerializer:SerializerBase<MagneticFlux>{
		public override MagneticFlux Deserialize(BsonDeserializationContext context, BsonDeserializationArgs args)
        {
            var up = UnitProvider.Default;
            IUnit result;
            if(up.TryGetUnit(typeof(MagneticFlux), context.Reader.ReadString(), out result))
                return (MagneticFlux)result;
