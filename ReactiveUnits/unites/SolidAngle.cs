...
// </auto-generated>
// <copyright file="SolidAngle.cs" company="Webcorp">
...
#endif
	[DataContract]
	[TypeConverter(typeof(UnitTypeConverter<SolidAngle>))]
    public partial class SolidAngle : Unit<SolidAngle>
    {
        /// <summary>
        ...
        {
            this.value = value;
			registeredSymbols = new List<string>() { "sr"};
        }
		...
		//[BsonSerializer(typeof(SolidAngleSerializer))]
        ...
        /// <summary>
        /// Gets or sets the value of the solid angle in the base unit.
        /// </summary>
        public override double Value
        {
			...
			set{
				throw new NotSupportedException("SolidAngle Doesn't support base value changing");
			}

        }

		 /// <summary>
        /// Gets if solid angle is variable or not
        /// </summary>
        ...
        /// </returns>
        public override int CompareTo(SolidAngle other)
        {
        ...
        /// </returns>
        public override bool Equals(SolidAngle other)
        {
        ...
        public override IUnit Add(IUnit x)
        {
            ...
            return new SolidAngle(this.value + x.Value);
        }
...
#if MONGO
	public class SolidAngleSerializer:SerializerBase<SolidAngle>{
		public override SolidAngle Deserialize(BsonDeserializationContext context, BsonDeserializationArgs args)
        {
            var up = UnitProvider.Default;
            IUnit result;
            if(up.TryGetUnit(typeof(SolidAngle), context.Reader.ReadString(), out result))
                return (SolidAngle)result;
