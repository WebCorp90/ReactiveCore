...
// </auto-generated>
// <copyright file="Action.cs" company="Webcorp">
...
#endif
	[DataContract]
	[TypeConverter(typeof(UnitTypeConverter<Action>))]
    public partial class Action : Unit<Action>
    {
        /// <summary>
        ...
        {
            this.value = value;
			registeredSymbols = new List<string>() { "au"};
        }
        ...
        /// The unit provider. 
        /// </param>
        public Action(string value, IUnitProvider unitProvider = null)
        {
		...
		//[BsonSerializer(typeof(ActionSerializer))]
        ...
        /// <summary>
        /// Gets or sets the value of the action in the base unit.
        /// </summary>
        public override double Value
        {
			...
			set{
				throw new NotSupportedException("Action Doesn't support base value changing");
			}

        }

		 /// <summary>
        /// Gets if action is variable or not
        /// </summary>
        ...
        /// A <see cref="Action"/> that represents the quantity in <paramref name="input" />. 
        /// </returns>
        public static Action Parse(string input, IUnitProvider unitProvider)
        {
            if (unitProvider == null)
            {
        ...
        public static bool TryParse(string input, IFormatProvider provider, IUnitProvider unitProvider, out Action result)
        {
            if (unitProvider == null)
            {
                unitProvider = provider as IUnitProvider ?? UnitProvider.Default;
        ...
        /// The <see cref="Action"/> .
        /// </returns>
        public static Action ParseJson(string input)
        {
        ...
        /// </returns>
        public static Action operator +(Action x, Action y)
        {
            return new Action(x.value + y.value);
        }
        ...
        /// The result of the operator. 
        /// </returns>
        public static Action operator /(Action x, double y)
        {
            return new Action(x.value / y);
        }
        ...
        /// The result of the operator. 
        /// </returns>
        public static double operator /(Action x, Action y)
        {
        ...
        /// The result of the operator. 
        /// </returns>
        public static Action operator *(double x, Action y)
        {
            return new Action(x * y.value);
        }
        ...
        /// The result of the operator. 
        /// </returns>
        public static Action operator +(Action x)
        {
        ...
        /// <summary>
        /// Compares this instance to the specified <see cref="Action"/> and returns an indication of their relative values.
        /// </summary>
        /// <param name="other">
        /// The other <see cref="Action"/> . 
        /// </param>
        /// <returns>
        /// A signed number indicating the relative values of this instance and the other value. 
        /// </returns>
        public override int CompareTo(Action other)
        {
        ...
        {
            return this.ConvertTo((Action)unit);
        }
        ...
        /// </returns>
        public double ConvertTo(Action unit)
        {
        ...
        /// <summary>
        /// Determines if the specified <see cref="Action"/> is equal to this instance.
        /// </summary>
        /// <param name="other">
        /// The other <see cref="Action"/> . 
        /// </param>
        ...
        public override IUnit Add(IUnit x)
        {
            ...
            return new Action(this.value + x.Value);
        }
...
#if MONGO
	public class ActionSerializer:SerializerBase<Action>{
		public override Action Deserialize(BsonDeserializationContext context, BsonDeserializationArgs args)
        {
            var up = UnitProvider.Default;
            IUnit result;
            if(up.TryGetUnit(typeof(Action), context.Reader.ReadString(), out result))
