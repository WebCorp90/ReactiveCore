...
// </auto-generated>
// <copyright file="Force.cs" company="Webcorp">
...
#endif
	[DataContract]
	[TypeConverter(typeof(UnitTypeConverter<Force>))]
    public partial class Force : Unit<Force>
    {
        /// <summary>
        ...
        {
            this.value = value;
			registeredSymbols = new List<string>() { "N","kgf","kipf"};
        }
        ...
        /// The unit provider. 
        /// </param>
        public Force(string value, IUnitProvider unitProvider = null)
        {
		...
		//[BsonSerializer(typeof(ForceSerializer))]
        ...
        /// <summary>
        /// Gets or sets the value of the force in the base unit.
        /// </summary>
        public override double Value
        {
			...
			set{
				throw new NotSupportedException("Force Doesn't support base value changing");
			}

        }

		 /// <summary>
        /// Gets if force is variable or not
        /// </summary>
        ...
        /// A <see cref="Force"/> that represents the quantity in <paramref name="input" />. 
        /// </returns>
        public static Force Parse(string input, IUnitProvider unitProvider)
        {
            if (unitProvider == null)
            {
        ...
        public static bool TryParse(string input, IFormatProvider provider, IUnitProvider unitProvider, out Force result)
        {
            if (unitProvider == null)
            {
                unitProvider = provider as IUnitProvider ?? UnitProvider.Default;
        ...
        /// The <see cref="Force"/> .
        /// </returns>
        public static Force ParseJson(string input)
        {
        ...
        /// The result of the operator. 
        /// </returns>
        public static double operator /(Force x, Force y)
        {
        ...
        /// The result of the operator. 
        /// </returns>
        public static Force operator +(Force x)
        {
        ...
        /// <summary>
        /// Compares this instance to the specified <see cref="Force"/> and returns an indication of their relative values.
        /// </summary>
        /// <param name="other">
        /// The other <see cref="Force"/> . 
        /// </param>
        /// <returns>
        /// A signed number indicating the relative values of this instance and the other value. 
        /// </returns>
        public override int CompareTo(Force other)
        {
        ...
        {
            return this.ConvertTo((Force)unit);
        }
        ...
        /// </returns>
        public double ConvertTo(Force unit)
        {
        ...
        /// <summary>
        /// Determines if the specified <see cref="Force"/> is equal to this instance.
        /// </summary>
        /// <param name="other">
        /// The other <see cref="Force"/> . 
        /// </param>
        ...
        /// </returns>
        public override bool Equals(Force other)
        {
        ...
        public override IUnit Add(IUnit x)
        {
            ...
            return new Force(this.value + x.Value);
        }
...
#if MONGO
	public class ForceSerializer:SerializerBase<Force>{
		public override Force Deserialize(BsonDeserializationContext context, BsonDeserializationArgs args)
        {
            var up = UnitProvider.Default;
            IUnit result;
            if(up.TryGetUnit(typeof(Force), context.Reader.ReadString(), out result))
                return (Force)result;
