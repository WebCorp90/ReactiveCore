...
namespace ReactiveHelpers.Core.Collections
{
#if !CORE
    [Serializable]
#endif
    ...
    public class Multimap<TKey, TValue> : IEnumerable<KeyValuePair<TKey, ICollection<TValue>>>
    {
        ...
        internal Multimap(IDictionary<TKey, ICollection<TValue>> dictionary, Func<IEnumerable<TValue>, ICollection<TValue>> collectionCreator)
        {
            ...
            Contract.Requires<ArgumentNullException>(collectionCreator != null, nameof(collectionCreator));
...
#region Static members
    ...
    public class MultiMapConverter : JsonConverter
    {
        ...
        public override bool CanConvert(Type objectType)
        {
            ...
            var canConvert = objectType.IsGenericType;
#endif
            return canConvert && objectType.GetGenericTypeDefinition() == typeof(Multimap<,>);
        }
