...
namespace ReactiveHelpers
{
    public static class StringExtensions
    {
        ...
        {
            Contract.Requires<ArgumentNullException>(suffix != null, nameof(suffix));
            Contract.Requires<ArgumentException>(maxLength >= 0, nameof(maxLength));
        ...
        {
            Contract.Requires<ArgumentNullException>(value != null, nameof(value));
            Contract.Requires<ArgumentNullException>(startsWith != null, nameof(startsWith));
        ...
        {
            Contract.Requires<ArgumentNullException>(value != null, nameof(value));
            Contract.Requires<ArgumentNullException>(endWith != null, nameof(endWith));
        ...
        */
        ...
        public static int[] ToIntArray(this string s)
        {
            ...
            s.SplitSafe(",").Each(v =>result.Add( int.Parse(v.Trim())));
        ...
        {
            Contract.Requires<ArgumentNullException>(preMatch != null, nameof(preMatch));
            Contract.Requires<ArgumentNullException>(postMatch != null, nameof(postMatch));
