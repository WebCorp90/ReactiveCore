using ReactiveHelpers.Core.Collections;
using System;
...
namespace ReactiveHelpers
{
    public static class EnumerableExtensions
    {
             ...
             IEqualityComparer<TKey> comparer)
        {
            ...
            Contract.Requires<ArgumentNullException>(keySelector != null, nameof(keySelector));
            Contract.Requires<ArgumentNullException>(elementSelector != null, nameof(elementSelector));
                                                ...
                                                Func<TSource, TValue> valueSelector)
        {
            Contract.Requires<ArgumentNullException>(source != null, nameof(source));
            Contract.Requires<ArgumentNullException>(keySelector != null, nameof(keySelector)); 
            Contract.Requires<ArgumentNullException>(valueSelector != null, nameof(valueSelector));
        ...
        {
            Contract.Requires<ArgumentNullException>(initial != null, nameof(initial));
