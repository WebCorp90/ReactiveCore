...
namespace ReactiveHelpers.ComponentModel
{
    ...
    public class NullableConverter : TypeConverterBase
    {
            ...
            : base(type)
        {
            ...
            _underlyingTypeIsConvertible = typeof(IConvertible).IsAssignableFrom(UnderlyingType);

#if CORE
            _underlyingTypeIsConvertible = _underlyingTypeIsConvertible && !UnderlyingType.IsEnum();
#else
            _underlyingTypeIsConvertible = _underlyingTypeIsConvertible && !UnderlyingType.IsEnum;
#endif
